...
The author is obligated to mention that this script is effectively a development playground, there's no such thing as stable builds. This script may introduce changes that are not backwards compatible with autoscend.

This is a large project, and there's a lot of things to do, and I'm obligated to mention AI is very handy in refactors. I'm probably going to die from stress, running out of time. If you want to work off the original typescript conversion, you can find it somewhere in the git history of mid 2026, but it's certainly a sight to behold, being generated by a rough one-job tool.
