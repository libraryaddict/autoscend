import { abort, availableAmount, buy, canDrink, canEat, canInteract, ceil, Class, cliExecute, Coinmaster, combatRateModifier, containsText, council, currentMcd, Effect, Element, equip, equippedItem, experienceBonus, Familiar, familiarEquippedEquipment, fullnessLimit, getAutoAttack, getClanRumpus, getProperty, getRevision, getWorkshed, gitInfo, guildStoreAvailable, haveEffect, haveEquipped, haveFamiliar, haveSkill, hiddenTempleUnlocked, hippyStoneBroken, inBadMoon, inebrietyLimit, inHardcore, isUnrestricted, Item, itemAmount, itemDropModifier, knollAvailable, lastMonster, Location, mallPrices, max, meatDropModifier, min, minstrelInstrument, Monster, monsterLevelAdjustment, mpCost, myAdventures, myAscensions, myBuffedstat, myClass, myDaycount, myFamiliar, myFullness, myHp, myInebriety, myLevel, myLightning, myLocation, myMaxhp, myMaxmp, myMeat, myMp, myName, myPath, myRain, mySessionAdv, mySoulsauce, mySpleenUse, myThunder, myTurncount, npcPrice, print, printHtml, pullsRemaining, putCloset, removeProperty, runChoice, setAutoAttack, setLocation, setProperty, Skill, Slot, spleenLimit, splitString, squareRoot, Stat, storageAmount, substring, toBoolean, todayToString, toFamiliar, toFloat, toInt, toItem, toMonster, toSlot, totalTurnsPlayed, use, useFamiliar, userConfirm, useSkill, visitUrl, wait } from "kolmafia";
import { acquireGumItem, acquireHermitItem, acquireTotem, auto_buyUpTo, handlePulls, LX_craftAcquireItems, pullXWhenHaveY, pulverizeThing } from "./autoscend/auto_acquire";
...
import { adjustForYellowRayIfPossible, almostRollover, auto_amIRich, auto_autosell, auto_get_campground, auto_have_skill, auto_interruptCheck, auto_is_valid, auto_log_debug, auto_log_debug$1, auto_log_info, auto_log_info$1, auto_log_warning, auto_meetsMinimumRequirements, auto_needAccordion, auto_predictAccordionTurns, autoCraft, backupSetting, banishSources, basicAdjustML, can_read_skillbook, copySources, doNumberology, doNumberology$2, freeCrafts$1, freeKillSources, freeRunSources, handleBarrelFullOfBarrels, handleSealElement, handleSealNormal, instaKillSources, internalQuestStatus, isArmoryAvailable, isFreeMonster, isHermitAvailable, isUnclePAvailable, maxSealSummons, meatReserveMessage, needToConsumeForEmergencyRollover, ovenHandle, restoreAllSettings, sniffSources, trim, use_barrels, yellowRaySources } from "./autoscend/auto_util";
...
import { auto_chapeau, auto_doPrecinct, auto_sourceTerminalEducate, auto_sourceTerminalRequest, isOverdueDigitize, LX_ghostBusting, witchessFights } from "./autoscend/iotms/mr2016";
import { asdonAutoFeed, horseDefault, kgb_getMartini, kgbSetup, loveTunnelAcquire, makeGeniePocket } from "./autoscend/iotms/mr2017";
...
import { auto_backupTarget, auto_backupToYourLastEnemy, auto_buyFireworksHat, auto_CMCconsult, auto_enableBackupCameraReverser, auto_harvestBatteries } from "./autoscend/iotms/mr2021";
...
import { auto_buyFrom2002MrStore, auto_defaultBurnLeaves, auto_doPhoneQuest, auto_habitatMonster, auto_initBurningLeaves, auto_lostStomach$1, auto_scepterSkills, auto_SITCourse, auto_useBlackMonolith, pickRocks, rockGardenEnd } from "./autoscend/iotms/mr2023";
import { auto_buyFromSeptEmberStore, auto_getAprilingBandItems, auto_getClanPhotoBoothDefaultItems, auto_getClanPhotoBoothEffect$3, auto_haveMayamCalendar, auto_MayamAllUsed, auto_MayamClaimAll } from "./autoscend/iotms/mr2024";
...
import { amw_initializeSettings, in_amw, LM_adventurerMeatsWorld } from "./autoscend/paths/adventurer_meats_world";
...
import { boris_buySkills, boris_initializeDay, boris_initializeSettings, is_boris, LM_boris } from "./autoscend/paths/avatar_of_boris";
import { is_jarlsberg, jarlsberg_buySkills, jarlsberg_initializeDay, jarlsberg_initializeSettings, LM_jarlsberg } from "./autoscend/paths/avatar_of_jarlsberg";
import { aosol_buySkills, aosol_initializeSettings, aosol_unCurse } from "./autoscend/paths/avatar_of_shadows_over_loathing";
import { is_pete, LM_pete, pete_buySkills, pete_initializeDay, pete_initializeSettings } from "./autoscend/paths/avatar_of_sneaky_pete";
import { awol_buySkills, awol_initializeSettings, awol_useStuff } from "./autoscend/paths/avatar_of_west_of_loathing";
import { bhy_initializeSettings, in_bhy, LM_bhy } from "./autoscend/paths/bees_hate_you";
import { bugbear_initializeSettings } from "./autoscend/paths/bugbear_invasion";
import { casualCheck, inAftercore, LM_canInteract } from "./autoscend/paths/casual";
import { in_community } from "./autoscend/paths/community_service";
import { bat_formNone, bat_initializeDay, bat_initializeSession, bat_initializeSettings, in_darkGyffte, LM_batpath } from "./autoscend/paths/dark_gyffte";
...
import { glover_initializeDay, glover_initializeSettings, in_glover, LM_glover } from "./autoscend/paths/g_lover";
...
import { bond_initializeSettings, LM_bond } from "./autoscend/paths/license_to_adventure";
import { in_lar, lar_safeguard, LM_lar } from "./autoscend/paths/live_ascend_repeat";
...
import { in_plumber, LM_plumber, plumber_canDealScalingDamage, plumber_equipTool$1, plumber_initializeSettings } from "./autoscend/paths/path_of_the_plumber";
...
import { in_theSource, LX_theSource, theSource_buySkills, theSource_initializeSettings, theSource_oracle } from "./autoscend/paths/the_source";
...
import { in_wildfire, LA_wildfire, LX_wildfire_calculateTheUniverse, wildfire_initializeSettings } from "./autoscend/paths/wildfire";
import { in_robot, LA_robot, LM_robot, robot_initializeSettings } from "./autoscend/paths/you_robot";
...
import { LX_dronesOut, LX_ForceNC, LX_handleIntroAdventures, useTonicDjinn } from "./autoscend/quests/level_any";
