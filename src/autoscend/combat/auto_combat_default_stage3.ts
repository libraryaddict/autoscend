import { buffedHitStat, Class, containsText, Effect, Element, equippedAmount, equippedItem, expectedDamage, Familiar, getProperty, haveEffect, haveEquipped, haveSkill, hippyStoneBroken, Item, itemAmount, itemDrops, itemType, Location, max, Monster, monsterDefense, monsterElement, monsterHp, monsterLevelAdjustment, monsterPhylum, mpCost, myBuffedstat, myClass, myFamiliar, myHp, myLocation, myMaxhp, myMp, numericModifier, Phylum, setProperty, Skill, Slot, Stat, toBoolean, toInt } from "kolmafia";
