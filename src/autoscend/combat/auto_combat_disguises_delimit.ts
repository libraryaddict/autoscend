...
export function disguises_combat_helper(round_1: number, enemy: Monster, text: string): void
{
...
export function auto_combatDisguisesStage1(round_1: number, enemy: Monster, text: string): string
{
...
export function auto_combatDisguisesStage5(round_1: number, enemy: Monster, text: string): string
{
	// stage 5 = kill
	if (!in_disguises())
	{
	...
	{ //welding mask
		...
		{
			if (myHp() > monsterHp() + 150 && canUse$1(Skill.get("Saucestorm"), false))
			{
