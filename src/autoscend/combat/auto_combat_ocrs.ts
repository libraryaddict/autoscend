...
export function ocrs_combat_helper(page: string): Monster
{
	...
	*/
	...
	{
		if (!combat_status_check("cleesh") && auto_have_skill(Skill.get("CLEESH")) && myMp() > 10)
		{
	...
	{
		if (containsText(page, "makes the most annoying noise you've ever heard, stopping you in your tracks."))
		{
