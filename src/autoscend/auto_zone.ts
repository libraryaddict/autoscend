...
export function zone_delayable(): Map<Location, number> {
  ...
  for (const loc of Location.get([
    "Your Mushroom Garden",
    "Pump Up Muscle",
    "Pump Up Mysticality",
    "Pump Up Moxie",
    "Richard's Hobo Mysticality",
    "Richard's Hobo Moxie",
    "Richard's Hobo Muscle",
    ...
    "Mer-kin Colosseum",
    "Mer-kin Temple",
    "Mer-kin Temple (Left Door)",
    "Mer-kin Temple (Center Door)",
    "Mer-kin Temple (Right Door)",
    "The Fungal Nethers",
    ...
    "Generic Summer Holiday Swimming!",
    "The Cave Before Time",
    "An Illicit Bohemian Party",
    "Moonshiners' Woods",
    "The Roman Forum",
    "The Post-Mall",
    "The Rowdy Saloon",
    ...
    "12 West Main",
    "KoL Con Clan Party House",
    "The Home of The Future",
    "Spring Bros. Solenoids",
    "Boltsmann Bearings",
    "The Primordial Stew",
    "No Man's And Also No Skeleton's Land",
    "Axis HQ",
    "Shadow Rift",
    ...
    "Spectral Salad Factory",
    "Shivering Timbers",
    "A Skeleton Invasion!",
    "The Cannon Museum",
    "A Swarm of Yeti-Mounted Skeletons",
    "The Bonewall",
    "A Massive Flying Battleship",
    "A Supply Train",
    "The Bone Star",
    "Grim Grimacite Site",
    ...
    "Fierce Flying Flames",
    "Lord Flameface's Castle Entryway",
    "Lord Flameface's Castle Belfry",
    "Lord Flameface's Throne Room",
    "A Stinking Abyssal Portal",
    "A Scorching Abyssal Portal",
    "A Terrifying Abyssal Portal",
    "A Freezing Abyssal Portal",
    "An Unsettling Abyssal Portal",
    ...
    "Chinatown Tenement",
    "The Gourd!",
    "The Tower of Procedurally-Generated Skeletons",
    ...
    "The Prince's Restroom",
    "The Prince's Dance Floor",
    "The Prince's Kitchen",
    "The Prince's Balcony",
    "The Prince's Lounge",
    "The Prince's Canapes Table",
    "Ye Olde Medievale Villagee",
    "Portal to Terrible Parents",
    ...
    "The Foreboding Cave",
    "The Faerie Cyrkle",
    "The Druidic Campsite",
    "Near the Witch's House",
    "The Evil Cathedral",
    "The Barrow Mounds",
    "The Cursed Village Thieves' Guild",
    "The Troll Fortress",
    "The Labyrinthine Crypt",
    "The Lair of the Phoenix",
    "The Dragon's Moor",
    "Duke Vampire's Chateau",
    "The Master Thief's Chalet",
    "The Spider Queen's Lair",
    "The Archwizard's Tower",
    "The Ley Nexus",
    "The Ghoul King's Catacomb",
    "The Ogre Chieftain's Keep",
    ...
    "The Haunted Kitchen (OLD)",
    "The Haunted Conservatory (OLD)",
    "The Haunted Billiards Room (OLD)",
    "The Haunted Bathroom (OLD)",
    "The Haunted Bedroom (OLD)",
    "The Black Forest (OLD)",
    "The Hidden City",
    "The Palindome (OLD)",
    "The Arid, Extra-Dry Desert (Dehydrated)",
    "The Arid, Extra-Dry Desert (Ultrahydrated)",
    "OLD The Upper Chamber",
    "OLD The Middle Chamber",
