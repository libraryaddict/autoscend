import { abort, availableChoiceOptions, Class, cliExecute, containsText, council, Effect, equippedItem, expectedDamage, Familiar, floor, getProperty, haveEffect, haveFamiliar, haveSkill, inHardcore, initiativeModifier, isBanished, isUnrestricted, Item, itemAmount, itemType, Location, min, Monster, myClass, myDaycount, myFullness, myMaxhp, myMp, myPrimestat, runChoice, setProperty, Skill, Slot, splitString, Stat, toInt, toLowerCase, toMonster, use, useSkill, visitUrl } from "kolmafia";
import { auto_buyUpTo } from "../auto_acquire";
import { autoAdv$1, autoAdv$2 } from "../auto_adventure";
import { buffMaintain$3, buffMaintain$4 } from "../auto_buff";
import { auto_spleenFamiliarAdvItemsPossessed, autoChew, spleen_left } from "../auto_consume";
import { addToMaximize, auto_forceEquipSword, auto_forceEquipSword$1, autoEquip$1, equipStatgainIncreasers$2, possessEquipment } from "../auto_equipment";
...
import { auto_badassBelt, auto_change_mcd, auto_combat_appearance_rates$1, auto_convertDesiredML, auto_have_skill, auto_is_valid, auto_is_valid$2, auto_is_valid$3, auto_log_debug$1, auto_log_info, auto_log_info$1, auto_log_warning, auto_MaxMLToCap, auto_turbo, canSniff, internalQuestStatus } from "../auto_util";
...
import { auto_backupUsesLeft, auto_FireExtinguisherCombatString } from "../iotms/mr2021";
