import { abort, availableChoiceOptions, blackMarketAvailable, buy, canDrink, canEquip, Class, cliExecute, closetAmount, Coinmaster, containsText, council, creatableAmount, create, Effect, Element, equip, equippedAmount, equippedItem, Familiar, friarsAvailable, getProperty, haveEffect, haveEquipped, haveSkill, hiddenTempleUnlocked, indexOf, inebrietyLimit, inHardcore, isBanished, Item, itemAmount, itemDropModifier, Location, max, Modifier, Monster, monsterLevelAdjustment, myAdventures, myAscensions, myBuffedstat, myClass, myDaycount, myFamiliar, myHash, myHp, myInebriety, myLevel, myMaxhp, myMeat, myMp, myPath, myPrimestat, mySign, myTurncount, npcPrice, numericModifier, Path, Phylum, pullsRemaining, random, retrieveItem, runChoice, setProperty, Skill, Slot, splitString, squareRoot, Stat, substring, takeCloset, toBoolean, toFloat, toInt, toItem, toLocation, toMonster, use, visitUrl } from "kolmafia";
import { auto_advToReserve, LX_doVacation, speculative_pool_skill } from "../../autoscend";
...
import { auto_autoConsumeOne, auto_findBestConsumeAction, autoDrink, canDrink$1, expectedAdventuresFrom, inebriety_left } from "../auto_consume";
...
import { auto_can_equip, auto_canForceNextNoncombat, auto_change_mcd, auto_combat_appearance_rates$1, auto_convertDesiredML, auto_forceNextNoncombat$1, auto_haveQueuedForcedNonCombat, auto_inRonin, auto_is_valid, auto_is_valid$2, auto_is_valid$3, auto_log_debug$1, auto_log_error, auto_log_info, auto_log_info$1, auto_log_warning, auto_log_warning$1, auto_MaxMLToCap, auto_wishForEffect, autoCraft, backupSetting, canSniff, canSummonMonster, cloversAvailable$1, internalQuestStatus, isGuildClass, lastAdventureSpecialNC, meatReserve, ovenHandle, restoreSetting, summonMonster } from "../auto_util";
...
import { considerGrimstoneGolem, handleBjornify, LX_ornateDowsingRod$1 } from "../iotms/mr2014";
...
import { isActuallyEd, L9_ed_chasmStart } from "../paths/actually_ed_the_undying";
