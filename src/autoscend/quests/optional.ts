import { abort, availableAmount, Class, cliExecute, containsText, creatableAmount, create, eatsilent, equippedItem, getDwelling, getInventory, getProperty, guildStoreAvailable, haveSkill, inebrietyLimit, inHardcore, Item, itemAmount, knollAvailable, Location, myAscensions, myClass, myInebriety, myLevel, myMeat, myPrimestat, myTurncount, npcPrice, outfit, outfitPieces, runChoice, setProperty, Skill, Slot, Stat, toBoolean, toInt, toSlot, use, visitUrl } from "kolmafia";
