import { abort, availableAmount, availableChoiceOptions, buy, canEquip, canInteract, ceil, Class, cliExecute, Coinmaster, containsText, council, creatableAmount, create, Effect, Element, equip, equippedItem, Familiar, getProperty, gnomadsAvailable, haveEffect, haveEquipped, haveFamiliar, haveSkill, inHardcore, Item, itemAmount, lastChoice, lastMonster, Location, max, meatDropModifier, min, Modifier, Monster, myAscensions, myBuffedstat, myClass, myDaycount, myFamiliar, myHp, myMaxhp, myMeat, myPrimestat, numericModifier, propertyExists, pullsRemaining, removeProperty, retrieveItem, runChoice, setProperty, Skill, Slot, Stat, toBoolean, toElement, toFamiliar, toInt, toLowerCase, toStat, useFamiliar, useSkill, visitUrl } from "kolmafia";
...
import { auto_can_equip, auto_equalizeStats, auto_getListOfNonDamagingFamiliarEquipment, auto_have_skill, auto_is_valid, auto_is_valid$3, auto_log_error, auto_log_info, auto_log_info$1, auto_log_warning, auto_log_warning$1, auto_turbo, auto_wishForEffect, auto_wishForEffectIfNeeded, autoMaximize$1, canSummonMonster, cloverUsageFinish, cloverUsageInit$1, cloverUsageRestart, hasTorso$1, hasUsefulShirt, internalQuestStatus, isGuildClass, MLDamageToMonsterMultiplier, shrugAT$1, summonedMonsterToday, summonMonster, woods_questStart } from "../auto_util";
...
import { in_koe, L13_koe_towerNSNagamar } from "../paths/kingdom_of_exploathing";
...
import { in_lowkeysummer, L13_sorceressDoorLowKey } from "../paths/low_key_summer";
