import { abort, availableAmount, ceil, cliExecute, closetAmount, Coinmaster, containsText, council, create, Effect, equip, equippedAmount, Familiar, getProperty, haveEffect, haveEquipped, haveSkill, inebrietyLimit, inHardcore, isUnrestricted, Item, itemAmount, itemDropModifier, lastMonster, Location, max, meatDropModifier, min, Monster, monsterLevelAdjustment, mpCost, myAdventures, myAscensions, myBuffedstat, myDaycount, myInebriety, myLevel, myMeat, myMp, npcPrice, outfit, sell, setProperty, Skill, Slot, Stat, takeCloset, toBoolean, toFamiliar, toFloat, toInt, toMonster, use, useFamiliar, useSkill, visitUrl } from "kolmafia";
...
import { highestScalingZone, isAboutToPowerlevel, LX_freeCombats$1 } from "../auto_powerlevel";
...
import { ed_DelayNC$1, edAcquireHP, isActuallyEd } from "../paths/actually_ed_the_undying";
...
import { in_koe, L12_koe_clearBattlefield, L12_koe_finalizeWar } from "../paths/kingdom_of_exploathing";
import { in_lol } from "../paths/legacy_of_loathing";
import { in_lar } from "../paths/live_ascend_repeat";
import { in_pokefam, L12_pokefam_clearBattlefield } from "../paths/pocket_familiars";
