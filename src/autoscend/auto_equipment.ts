import { abort, appearanceRates, booleanModifier, canEquip, Class, cliExecute, containsText, Effect, endsWith, equip, equippedAmount, equippedItem, Familiar, familiarWeight, fullnessLimit, getInventory, getProperty, getRelated, haveEffect, haveSkill, hippyStoneBroken, inebrietyLimit, inHardcore, isUnrestricted, isWearingOutfit, Item, itemAmount, itemType, length, Location, max, maximize, min, Modifier, Monster, myAdventures, myBasestat, myClass, myFamiliar, myHp, myLevel, myLocation, myMaxhp, myMaxmp, myMeat, myMp, myPath, myPrimestat, npcPrice, numericModifier, outfitPieces, Path, replaceString, retrieveItem, setLocation, setProperty, Skill, Slot, splitString, startsWith, Stat, substring, toBoolean, toFloat, toInt, toItem, toLocation, toLowerCase, toMonster, toSlot, weaponHands, weaponType } from "kolmafia";
...
import { auto_burnMP, auto_can_equip, auto_can_equip$1, auto_have_skill, auto_ignoreExperience, auto_is_valid, auto_log_debug, auto_log_error, auto_log_info, auto_log_info$1, auto_log_warning, auto_log_warning$1, autoMaximize, instakillable, isArmoryAndLeggeryStoreAvailable, isFreeMonster, meatReserve, wrap_item } from "./auto_util";
