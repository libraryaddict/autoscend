import { abort, availableAmount, buy, canAdventure, canInteract, cliExecute, Coinmaster, containsText, creatableAmount, create, Effect, equippedItem, expectedDamage, Familiar, floor, fullnessLimit, getCampground, getDwelling, getLocationMonsters, getProperty, haveCampground, haveEffect, haveEquipped, haveFamiliar, haveSkill, inHardcore, Item, itemAmount, itemFact, Location, max, monkeyPaw, Monster, myAdventures, myDaycount, myFamiliar, myFullness, myLevel, myLocation, myMaxhp, myMeat, myPokeFam, myPrimestat, numericModifier, Phylum, setProperty, Skill, Slot, Stat, toBoolean, toFamiliar, toInt, toLowerCase, toMonster, turnsPlayed, use, useFamiliar, useSkill, visitUrl, weaponHands } from "kolmafia";
...
import { auto_can_equip, auto_canForceNextNoncombat, auto_forceNextNoncombat$1, auto_get_campground, auto_have_skill, auto_haveQueuedForcedNonCombat, auto_ignoreExperience, auto_is_valid, auto_is_valid$2, auto_is_valid$4, auto_log_debug$1, auto_log_info$1, auto_queueIgnore, auto_turbo, auto_wantToFreeKillWithNoDrops, backupSetting, can_read_skillbook, handleTracker$1, handleTracker$2, haveCampgroundMaid, isFreeMonster$1, isGuildClass, meatReserve, wrap_item } from "../auto_util";
