...
export function lol_buyReplicas(): boolean {
  ...
  while (itemAmount(Item.get("replica Mr. Accessory")) > 0) {
    ...
    if (containsText(page, "cincho")) {
      //2023
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica Cincho de Mayo"),
      );
    }
    if (containsText(page, "2002")) {
      ...
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("Replica 2002 Mr. Store Catalog"),
      );
    ...
    if (containsText(page, "patriotic eagle") && !is100FamRun()) {
      ...
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica sleeping patriotic eagle"),
      );
    ...
    if (containsText(page, "august scepter")) {
      ...
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica august scepter"),
      );
      auto_scepterSkills();
    }
    ...
    if (containsText(page, "<b>2004</b>")) {
      if (
        haveFamiliar(Familiar.get("Jill-O-Lantern")) ||
        haveFamiliar(Familiar.get("Hand Turkey"))
      ) {
        // already bought one
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica crimbo elfling"),
        );
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica hand turkey outline"),
        );
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Dark Jill-O-Lantern"),
        );
      ...
      if (availableAmount(Item.get("replica wax lips")) === 0) {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica wax lips"),
        );
      } else {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica miniature gravy-covered maypole"),
        );
      }
      ...
      if (availableAmount(Item.get("replica jewel-eyed wizard hat")) === 0) {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica jewel-eyed wizard hat"),
        );
      } else {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Tome of Snowcone Summoning"),
        );
      }
    } else if (containsText(page, "<b>2007</b>")) {
      if (
        availableAmount(Item.get("replica navel ring of navel gazing")) === 0
      ) {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica navel ring of navel gazing"),
        );
      } else {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica V for Vivala mask"),
        );
      }
      ...
      if (availableAmount(Item.get("replica haiku katana")) === 0) {
        ...
        if (!is100FamRun()) {
          ...
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica cotton candy cocoon"),
          );
          ...
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica little box of fireworks"),
          );
        }
      }
      ...
      if (is100FamRun()) {
        ...
        if (itemAmount(Item.get("replica Elvish sunglasses")) < 1) {
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica Elvish sunglasses"),
          );
        } else {
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica Apathargic Bandersnatch"),
          );
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica squamous polyp"),
        );
      ...
      if (availableAmount(Item.get("replica Greatest American Pants")) === 0) {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Greatest American Pants"),
        );
      } else {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica organ grinder"),
        );
      }
      ...
      if (is100FamRun()) {
        ...
        if (containsText(page, "replica Operation Patriot Shield")) {
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica Operation Patriot Shield"),
          );
        } else {
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica plastic vampire fangs"),
          );
        }
      ...
      if (itemAmount(Item.get("replica Libram of Resolutions")) === 0) {
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Libram of Resolutions"),
        );
        ...
        if (!is100FamRun()) {
          ...
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica deactivated nanobots"),
          );
          ...
          buy(
            Coinmaster.get("Replica Mr. Store"),
            1,
            Item.get("replica Camp Scout backpack"),
          );
        }
      }
      ...
      if (!is100FamRun()) {
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Crimbo sapling"),
        );
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Little Geneticist DNA-Splicing Lab"),
        );
      ...
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica Deck of Every Card"),
      );
    } else if (containsText(page, "<b>2016</b>")) {
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica Source terminal"),
      );
      ...
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica genie bottle"),
      );
    } else if (containsText(page, "<b>2018</b>")) {
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica January's Garbage Tote"),
      );
    } else if (containsText(page, "<b>2019</b>")) {
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica Kramco Sausage-o-Matic&trade;"),
      );
      ...
      if (!is100FamRun()) {
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica baby camelCalf"),
        );
        ...
        buy(
          Coinmaster.get("Replica Mr. Store"),
          1,
          Item.get("replica Powerful Glove"),
        );
      }
      ...
      buy(
        Coinmaster.get("Replica Mr. Store"),
        1,
        Item.get("replica Jurassic Parka"),
      );
    } else if (
      itemAmount(
        //
        Item.get("replica Mr. Accessory"),
      ) > 0
    ) {
      abort(
