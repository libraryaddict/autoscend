import { abort, autosell, buy, ceil, cliExecute, closetAmount, Coinmaster, containsText, council, Effect, Element, equippedAmount, getProperty, haveServant, haveSkill, hippyStoneBroken, Item, itemAmount, Location, max, min, mpCost, myAdventures, myAscensions, myDaycount, myHp, myLevel, myMaxhp, myMaxmp, myMeat, myMp, myPath, myServant, mySessionAdv, mySpleenUse, myTurncount, Path, putCloset, removeProperty, runChoice, Servant, setProperty, Skill, Slot, spleenLimit, takeCloset, toBoolean, toInt, toLowerCase, use, useServant, useSkill, visitUrl } from "kolmafia";
