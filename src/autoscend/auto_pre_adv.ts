import { Class, Effect, Element, Familiar, Item, Location, Modifier, Monster, Skill, Slot, Stat, Thrall, abort, appearanceRates, canEat, ceil, changeMcd, cliExecute, combatRateModifier, containsText, creatableAmount, create, currentMcd, equip, equippedAmount, equippedItem, experienceBonus, getMonsters, getProperty, haveEffect, haveEquipped, inHardcore, inebrietyLimit, initiativeModifier, isUnrestricted, isWearingOutfit, itemAmount, itemDropModifier, meatDropModifier, monsterAttack, monsterElement, monsterLevelAdjustment, monsterPhylum, mpCost, myBasestat, myBuffedstat, myClass, myCompanion, myFamiliar, myFury, myHp, myInebriety, myLevel, myLocation, myMaxfury, myMaxhp, myMaxmp, myMeat, myMp, myPath, myPrimestat, myServant, mySessionAdv, mySign, mySoulsauce, myThrall, myTurncount, npcPrice, numericModifier, putCloset, retrieveItem, setProperty, splitString, toBoolean, toFamiliar, toInt, toLocation, toMonster, use, useFamiliar, useSkill } from "kolmafia";
import { speculative_pool_skill } from "../autoscend";
import { auto_buyUpTo } from "./auto_acquire";
import { buffMaintain$3, buffMaintain$4 } from "./auto_buff";
import { addBonusToMaximize, addToMaximize, autoEquip, autoEquip$1, autoForceEquip$1, autoForceEquip$3, autoOutfit, auto_equipFreekill, auto_saveEquipped, equipMaximizedGear, equipOverrides, equipStatgainIncreasers$1, equipStatgainIncreasers$2, possessEquipment, possessOutfit$1, removeFromMaximize, simMaximizeWith$1, simValue } from "./auto_equipment";
...
import { auto_FireExtinguisherCombatString, auto_backupTarget, auto_fireExtinguisherCharges, auto_forceHandleCrystalBall, auto_haveCrystalBall, auto_haveFireExtinguisher, have_fireworks_shop } from "./iotms/mr2021";
...
import { edAcquireHP, edAcquireHP$1, ed_handleAdventureServant, isActuallyEd } from "./paths/actually_ed_the_undying";
