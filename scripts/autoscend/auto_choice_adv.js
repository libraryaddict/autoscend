...
function List$8(data) {
  ...
  temp = new Map(
    _toConsumableArray(temp.entries()).sort((a, b) => a[0] - b[0])
  );
  var index = 0;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      for (var i = 0; i < depth; i++) {
        ...
        current.set(key, leaf instanceof CtorLeaf ? _construct(
          leaf.ctor,
...
var AshMatcher = /* @__PURE__ */ (function() {
  ...
  return _createClass(AshMatcher2, [{ key: "find", value: function find() {
    ...
    value: function group() {
      ...
      if (typeof _group === "number") return this.match[_group] !== void 0 ? this.match[_group] : "";
    ...
    value: function groupNames() {
      ...
      var _iterator2 = _createForOfIteratorHelper(
        this.pattern.source.matchAll(/\(\?<([a-zA-Z][a-zA-Z0-9]*)>/g)
      ), _step2;
      try {
    ...
    var nonGlobal = new RegExp(this.pattern.source, this.pattern.flags.replace("g", ""));
    ...
    var rep = replacement.replace(/\\(.)|\$([0-9]+)|\$\{([a-zA-Z][a-zA-Z0-9]*)\}/g, (m, esc, g, n) => {
      var _groups;
...
function is_boris() {
  return (0, import_kolmafia4.myPath)() === import_kolmafia4.Path.get("Avatar of Boris");
}

// src/autoscend/paths/avatar_of_jarlsberg.ts
var import_kolmafia5 = require("kolmafia");
function is_jarlsberg() {
  return (0, import_kolmafia5.myPath)() === import_kolmafia5.Path.get("Avatar of Jarlsberg");
}

// src/autoscend/paths/avatar_of_sneaky_pete.ts
var import_kolmafia6 = require("kolmafia");
function is_pete() {
  return (0, import_kolmafia6.myPath)() === import_kolmafia6.Path.get("Avatar of Sneaky Pete");
}
...
// src/autoscend/auto_monsterparts.ts
...
function auto_haveArchaeologistSpade() {
  if (auto_is_valid(import_kolmafia10.Item.get("Archaeologist's Spade")) && (0, import_kolmafia10.availableAmount)(import_kolmafia10.Item.get("Archaeologist's Spade")) > 0) {
    return true;
  }
  return false;
}
function auto_spadeDigsRemaining() {
  ...
  return 11 - (0, import_kolmafia10.toInt)((0, import_kolmafia10.getProperty)("_archSpadeDigs"));
}
function legendaryNoodlesChoiceHandler() {
  var target_choice = 0;
  if ((0, import_kolmafia10.toBoolean)((0, import_kolmafia10.getProperty)("auto_forceCombatWithLegendaryNoodles"))) {
    target_choice = 2;
    (0, import_kolmafia10.setProperty)("auto_forceCombatWithLegendaryNoodles", false.toString());
  } else if (!(0, import_kolmafia10.toBoolean)(
    // or use a spleen instead of a stomach
    (0, import_kolmafia10.getProperty)("_legendaryNoodlesSpleen")
  ) && spleen_left() > 0) {
    target_choice = 1;
  } else {
    target_choice = 4;
  }
  if (target_choice in (0, import_kolmafia10.availableChoiceOptions)()) {
    (0, import_kolmafia10.runChoice)(target_choice);
  } else {
    (0, import_kolmafia10.runChoice)(5);
  }
}
...
function in_amw() {
  return (0, import_kolmafia11.myPath)() === import_kolmafia11.Path.get("Adventurer Meats World");
}
...
function in_glover() {
  return (0, import_kolmafia12.myPath)() === import_kolmafia12.Path.get("G-Lover");
}
function glover_usable(it) {
  if (!in_glover()) {
    return true;
  }
  if ((0, import_kolmafia12.containsText)(it, "g")) {
    return true;
  }
  if ((0, import_kolmafia12.containsText)(it, "G")) {
    return true;
  }
  var checkItem = (0, import_kolmafia12.toItem)(it);
  if (checkItem !== import_kolmafia12.Item.none && import_kolmafia12.Item.get([
...
function in_wereprof() {
  return (0, import_kolmafia13.myPath)() === import_kolmafia13.Path.get("WereProfessor");
}
function is_werewolf() {
  if (!in_wereprof()) {
    return false;
  }
  if ((0, import_kolmafia13.haveEffect)(import_kolmafia13.Effect.get("Savage Beast")) > 0) {
    return true;
  }
  return false;
}
function is_professor() {
  ...
  if ((0, import_kolmafia13.haveEffect)(import_kolmafia13.Effect.get("Mild-Mannered Professor")) > 0) {
    return true;
  }
  return false;
}
...
function in_plumber() {
  return (0, import_kolmafia16.myPath)() === import_kolmafia16.Path.get("Path of the Plumber");
}
function plumber_equippedHammer() {
  return (0, import_kolmafia16.equippedItem)(import_kolmafia16.Slot.get("weapon")) === import_kolmafia16.Item.get("hammer") || (0, import_kolmafia16.equippedItem)(import_kolmafia16.Slot.get("weapon")) === import_kolmafia16.Item.get("heavy hammer");
}
function plumber_equippedFlower() {
  return (0, import_kolmafia16.equippedItem)(import_kolmafia16.Slot.get("weapon")) === import_kolmafia16.Item.get("[10462]fire flower") || (0, import_kolmafia16.equippedItem)(import_kolmafia16.Slot.get("weapon")) === import_kolmafia16.Item.get("bonfire flower");
}
function plumber_equippedBoots() {
  return (0, import_kolmafia16.haveEquipped)(import_kolmafia16.Item.get("work boots")) || (0, import_kolmafia16.haveEquipped)(import_kolmafia16.Item.get("fancy boots"));
}
function plumber_skillValid(sk) {
  if (!in_plumber()) {
    return true;
  }
  if (import_kolmafia16.Skill.get(["Jump Attack", "[25005]Spin Jump", "[25006]Multi-Bounce"]).includes(sk)) {
    return plumber_equippedBoots();
  } else if (import_kolmafia16.Skill.get(["Fireball Toss", "[25003]Juggle Fireballs", "[25004]Fireball Barrage"]).includes(sk)) {
    return plumber_equippedFlower();
  } else if (import_kolmafia16.Skill.get(["Hammer Smash", "[25001]Hammer Throw", "[25002]Ultra Smash"]).includes(sk)) {
...
function mushroomGardenChoiceHandler(choice) {
  if (choice === 1410) {
    var growth = (0, import_kolmafia17.getProperty)("auto_mushroomGardenGrowth");
    var pick = 1;
    if (growth !== "") {
      pick = (0, import_kolmafia17.min)((0, import_kolmafia17.toInt)(growth), 11);
    }
    if ((0, import_kolmafia17.toInt)((0, import_kolmafia17.getProperty)("mushroomGardenCropLevel")) >= pick) {
      (0, import_kolmafia17.runChoice)(2);
    } else {
      (0, import_kolmafia17.runChoice)(1);
    }
  } else {
    (0, import_kolmafia17.abort)("unhandled choice in mushroomGardenChoiceHandler");
  }
}
function auto_monsterToMap(loc, page) {
  var mons = new AshMatcher('heyscriptswhatsupwinkwink" value="(\\d+)', page);
  var monOpts = /* @__PURE__ */ new Map();
  var i = 0;
  var bestmon = 0;
  while (mons.find()) {
    monOpts.set(i, (0, import_kolmafia17.toMonster)((0, import_kolmafia17.toInt)(mons.group(1))));
    if (zoneRank$1(monOpts.get(i) ?? monOpts.set(i, import_kolmafia17.Monster.none).get(i), loc) <= zoneRank$1(monOpts.get(bestmon) ?? monOpts.set(bestmon, import_kolmafia17.Monster.none).get(bestmon), loc)) {
      bestmon = i;
    }
    i += 1;
  }
  return monOpts.get(bestmon) ?? monOpts.set(bestmon, import_kolmafia17.Monster.none).get(bestmon);
}
function cartographyChoiceHandler(choice, page) {
  auto_log_info(`cartographyChoiceHandler Running choice ${choice}`, "blue");
  if (choice === 1425) {
    if ((0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Orcish frat-paddle")) > 0) {
      (0, import_kolmafia17.runChoice)(1);
    } else if ((0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Orcish baseball cap")) > 0) {
      (0, import_kolmafia17.runChoice)(2);
    } else if ((0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Orcish cargo shorts")) > 0) {
      (0, import_kolmafia17.runChoice)(3);
    } else if ((0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Orcish frat-paddle")) > 0 && (0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Orcish baseball cap")) > 0 && (0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Orcish cargo shorts")) > 0) {
      (0, import_kolmafia17.runChoice)(4);
    } else {
      (0, import_kolmafia17.runChoice)(1);
    }
  } else if (choice === 1427) {
    ...
    if (internalQuestStatus("questL10Garbage") === 9) {
      if ((0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("model airship")) > 0) {
        (0, import_kolmafia17.runChoice)(1);
      } else if ((0, import_kolmafia17.haveEquipped)(import_kolmafia17.Item.get("Mohawk wig"))) {
        (0, import_kolmafia17.runChoice)(4);
      } else {
        (0, import_kolmafia17.runChoice)(3);
      }
    ...
    var fire_protestors = (0, import_kolmafia17.itemAmount)(import_kolmafia17.Item.get("Flamin' Whatshisname")) > 0 ? 10 : 3;
    var sleaze_amount = (0, import_kolmafia17.numericModifier)("sleaze damage") + (0, import_kolmafia17.numericModifier)("sleaze spell damage");
    var sleaze_protestors = (0, import_kolmafia17.squareRoot)(sleaze_amount);
    var lynyrd_protestors = (0, import_kolmafia17.haveEffect)(import_kolmafia17.Effect.get("Musky")) > 0 ? 6 : 3;
    var _iterator2 = _createForOfIteratorHelper(
      import_kolmafia17.Item.get(["lynyrdskin cap", "lynyrdskin tunic", "lynyrdskin breeches"])
    ), _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
        var it = _step2.value;
        if ((0, import_kolmafia17.equippedAmount)(it) > 0) {
          lynyrd_protestors += 5;
        }
      }
    } catch (err) {
    ...
    var best_protestors = (0, import_kolmafia17.max)(fire_protestors, (0, import_kolmafia17.max)(sleaze_protestors, lynyrd_protestors));
    ...
    var enemy = auto_monsterToMap((0, import_kolmafia17.myLocation)(), page);
    if (enemy !== import_kolmafia17.Monster.none) {
      handleTracker$1(import_kolmafia17.Skill.get("Map the Monsters").toString(), enemy.toString(), "auto_mapperidot");
      (0, import_kolmafia17.runChoice)(1, `heyscriptswhatsupwinkwink=${(0, import_kolmafia17.toInt)(enemy)}`);
    } else {
      (0, import_kolmafia17.abort)("trying to map a monster but don't know which monster to map!");
    }
  } else if (choice === 1436) {
    ...
    (0, import_kolmafia17.abort)("unhandled choice in cartographyChoiceHandler");
  }
}
...
function in_bhy() {
  return (0, import_kolmafia21.myPath)() === import_kolmafia21.Path.get("Bees Hate You");
}
function bhy_usable(str) {
  ...
  if ((0, import_kolmafia21.containsText)(str, "b")) {
    return false;
  }
  if ((0, import_kolmafia21.containsText)(str, "B")) {
    return false;
...
function bhy_is_item_valid(it) {
  if (!in_bhy()) {
    (0, import_kolmafia21.abort)("bhy_is_item_valid(item it) should never be called outside of bees hate you path.");
  }
  if ((0, import_kolmafia21.toSlot)(it) !== import_kolmafia21.Slot.none) {
    return (0, import_kolmafia21.isUnrestricted)(it);
  }
  if (import_kolmafia21.Item.get(["Cobb's Knob map", "enchanted bean", "ball polish", "black market map", "boring binder clip", "beehive", "electric boning knife"]).includes(it)) {
    return true;
  }
  return bhy_usable(it.toString()) && (0, import_kolmafia21.isUnrestricted)(it);
}

// src/autoscend/paths/bugbear_invasion.ts
var import_kolmafia22 = require("kolmafia");
function in_bugbear() {
  return (0, import_kolmafia22.myPath)() === import_kolmafia22.Path.get("Bugbear Invasion");
}
...
function in_heavyrains() {
  return (0, import_kolmafia24.myPath)() === import_kolmafia24.Path.get("Heavy Rains");
}

// src/autoscend/paths/kolhs.ts
var import_kolmafia25 = require("kolmafia");
function in_kolhs() {
  return (0, import_kolmafia25.myPath)() === import_kolmafia25.Path.get("KOLHS");
}
function kolhsChoiceHandler(choice) {
  auto_log_debug$1("Running kolhsChoiceHandler");
  {
    ...
    switch (choice) {
      case 700:
        if ((0, import_kolmafia25.haveEffect)(import_kolmafia25.Effect.get("Jamming with the Jocks")) > 0) {
          (0, import_kolmafia25.runChoice)(1);
        } else if ((0, import_kolmafia25.haveEffect)(import_kolmafia25.Effect.get("Nerd is the Word")) > 0) {
          (0, import_kolmafia25.runChoice)(2);
        } else if ((0, import_kolmafia25.haveEffect)(import_kolmafia25.Effect.get("Greaser Lightnin'")) > 0) {
          (0, import_kolmafia25.runChoice)(3);
        } else {
        ...
        break;
      case 772:
        target = (0, import_kolmafia25.toInt)((0, import_kolmafia25.getProperty)("_NC772_directive"));
        (0, import_kolmafia25.removeProperty)("_NC772_directive");
        if (target === 0) {
          (0, import_kolmafia25.abort)("We are in [saved by the bell] and do not know what to do because _NC772_directive is not valid or set. Leaving will waste this NC so do something manually");
        }
        if (target in (0, import_kolmafia25.availableChoiceOptions)()) {
          if (target === 3) {
            (0, import_kolmafia25.setProperty)("_yearbookClubVisitedToday", true.toString());
          }
          (0, import_kolmafia25.runChoice)(target);
        } else {
          (0, import_kolmafia25.abort)(`We are in [saved by the bell] and do not know what to do. Wanted to press button number ${target} but it mysteriously does not exist. Leaving will waste this NC so do something manually`);
        }
        break;
      default:
        break;
...
function in_lol() {
  return (0, import_kolmafia26.myPath)() === import_kolmafia26.Path.get("Legacy of Loathing");
}
function auto_ItemToReplica(it) {
  switch (it) {
    case import_kolmafia26.Item.get("Mr. Accessory"):
      return import_kolmafia26.Item.get("replica Mr. Accessory");
    case import_kolmafia26.Item.get("crimbo elfling"):
      return import_kolmafia26.Item.get("replica crimbo elfling");
    case import_kolmafia26.Item.get("Dark Jill-O-Lantern"):
      return import_kolmafia26.Item.get("replica Dark Jill-O-Lantern");
    case import_kolmafia26.Item.get("hand turkey outline"):
      return import_kolmafia26.Item.get("replica hand turkey outline");
    case import_kolmafia26.Item.get("miniature gravy-covered maypole"):
      return import_kolmafia26.Item.get("replica miniature gravy-covered maypole");
    case import_kolmafia26.Item.get("pygmy bugbear shaman"):
      return import_kolmafia26.Item.get("replica pygmy bugbear shaman");
    case import_kolmafia26.Item.get("wax lips"):
      return import_kolmafia26.Item.get("replica wax lips");
    case import_kolmafia26.Item.get("jewel-eyed wizard hat"):
      return import_kolmafia26.Item.get("replica jewel-eyed wizard hat");
    case import_kolmafia26.Item.get("plastic pumpkin bucket"):
      return import_kolmafia26.Item.get("replica plastic pumpkin bucket");
    case import_kolmafia26.Item.get("Tome of Snowcone Summoning"):
      return import_kolmafia26.Item.get("replica Tome of Snowcone Summoning");
    case import_kolmafia26.Item.get("bottle-rocket crossbow"):
      return import_kolmafia26.Item.get("replica bottle-rocket crossbow");
    case import_kolmafia26.Item.get("navel ring of navel gazing"):
      return import_kolmafia26.Item.get("replica navel ring of navel gazing");
    case import_kolmafia26.Item.get("V for Vivala mask"):
      return import_kolmafia26.Item.get("replica V for Vivala mask");
    case import_kolmafia26.Item.get("cotton candy cocoon"):
      return import_kolmafia26.Item.get("replica cotton candy cocoon");
    case import_kolmafia26.Item.get("haiku katana"):
      return import_kolmafia26.Item.get("replica haiku katana");
    case import_kolmafia26.Item.get("little box of fireworks"):
      return import_kolmafia26.Item.get("replica little box of fireworks");
    case import_kolmafia26.Item.get("Apathargic Bandersnatch"):
      return import_kolmafia26.Item.get("replica Apathargic Bandersnatch");
    case import_kolmafia26.Item.get("Elvish sunglasses"):
      return import_kolmafia26.Item.get("replica Elvish sunglasses");
    case import_kolmafia26.Item.get("squamous polyp"):
      return import_kolmafia26.Item.get("replica squamous polyp");
    case import_kolmafia26.Item.get("Greatest American Pants"):
      return import_kolmafia26.Item.get("replica Greatest American Pants");
    case import_kolmafia26.Item.get("Juju Mojo Mask"):
      return import_kolmafia26.Item.get("replica Juju Mojo Mask");
    case import_kolmafia26.Item.get("organ grinder"):
      return import_kolmafia26.Item.get("replica organ grinder");
    case import_kolmafia26.Item.get("a cute angel"):
      return import_kolmafia26.Item.get("replica cute angel");
    case import_kolmafia26.Item.get("Operation Patriot Shield"):
      return import_kolmafia26.Item.get("replica Operation Patriot Shield");
    case import_kolmafia26.Item.get("plastic vampire fangs"):
      return import_kolmafia26.Item.get("replica plastic vampire fangs");
    case import_kolmafia26.Item.get("Camp Scout backpack"):
      return import_kolmafia26.Item.get("replica Camp Scout backpack");
    case import_kolmafia26.Item.get("deactivated nanobots"):
      return import_kolmafia26.Item.get("replica deactivated nanobots");
    case import_kolmafia26.Item.get("Libram of Resolutions"):
      return import_kolmafia26.Item.get("replica Libram of Resolutions");
    case import_kolmafia26.Item.get("Order of the Green Thumb Order Form"):
      return import_kolmafia26.Item.get("replica Order of the Green Thumb Order Form");
    case import_kolmafia26.Item.get("over-the-shoulder Folder Holder"):
      return import_kolmafia26.Item.get("replica over-the-shoulder Folder Holder");
    case import_kolmafia26.Item.get("The Smith's Tome"):
      return import_kolmafia26.Item.get("replica Smith's Tome");
    case import_kolmafia26.Item.get("Crimbo sapling"):
      return import_kolmafia26.Item.get("replica Crimbo sapling");
    case import_kolmafia26.Item.get("Little Geneticist DNA-Splicing Lab"):
      return import_kolmafia26.Item.get("replica Little Geneticist DNA-Splicing Lab");
    case import_kolmafia26.Item.get("still grill"):
      return import_kolmafia26.Item.get("replica still grill");
    case import_kolmafia26.Item.get("Chateau Mantegna room key"):
      return import_kolmafia26.Item.get("replica Chateau Mantegna room key");
    case import_kolmafia26.Item.get("Deck of Every Card"):
      return import_kolmafia26.Item.get("replica Deck of Every Card");
    case import_kolmafia26.Item.get("Witchess Set"):
      return import_kolmafia26.Item.get("replica Witchess Set");
    case import_kolmafia26.Item.get("disconnected intergnat"):
      return import_kolmafia26.Item.get("replica disconnected intergnat");
    case import_kolmafia26.Item.get("Source terminal"):
      return import_kolmafia26.Item.get("replica Source terminal");
    case import_kolmafia26.Item.get("yellow puck"):
      return import_kolmafia26.Item.get("replica yellow puck");
    case import_kolmafia26.Item.get("genie bottle"):
      return import_kolmafia26.Item.get("replica genie bottle");
    case import_kolmafia26.Item.get("space planula"):
      return import_kolmafia26.Item.get("replica space planula");
    case import_kolmafia26.Item.get("unpowered Robortender"):
      return import_kolmafia26.Item.get("replica unpowered Robortender");
    case import_kolmafia26.Item.get("God Lobster Egg"):
      return import_kolmafia26.Item.get("replica God Lobster Egg");
    case import_kolmafia26.Item.get("January's Garbage Tote"):
      return import_kolmafia26.Item.get("replica January's Garbage Tote");
    case import_kolmafia26.Item.get("Neverending Party invitation envelope"):
      return import_kolmafia26.Item.get("replica Neverending Party invitation envelope");
    case import_kolmafia26.Item.get("Fourth of May Cosplay Saber"):
      return import_kolmafia26.Item.get("replica Fourth of May Cosplay Saber");
    case import_kolmafia26.Item.get("hewn moon-rune spoon"):
      return import_kolmafia26.Item.get("replica hewn moon-rune spoon");
    case import_kolmafia26.Item.get("Kramco Sausage-o-Matic&trade;"):
      return import_kolmafia26.Item.get("replica Kramco Sausage-o-Matic&trade;");
    case import_kolmafia26.Item.get("baby camelCalf"):
      return import_kolmafia26.Item.get("replica baby camelCalf");
    case import_kolmafia26.Item.get("Cargo Cultist Shorts"):
      return import_kolmafia26.Item.get("replica Cargo Cultist Shorts");
    case import_kolmafia26.Item.get("Powerful Glove"):
      return import_kolmafia26.Item.get("replica Powerful Glove");
    case import_kolmafia26.Item.get("emotion chip"):
      return import_kolmafia26.Item.get("replica emotion chip");
    case import_kolmafia26.Item.get("industrial fire extinguisher"):
      return import_kolmafia26.Item.get("replica industrial fire extinguisher");
    case import_kolmafia26.Item.get("miniature crystal ball"):
      return import_kolmafia26.Item.get("replica miniature crystal ball");
    case import_kolmafia26.Item.get("designer sweatpants"):
      return import_kolmafia26.Item.get("replica designer sweatpants");
    case import_kolmafia26.Item.get("grey gosling"):
      return import_kolmafia26.Item.get("replica grey gosling");
    case import_kolmafia26.Item.get("Jurassic Parka"):
      return import_kolmafia26.Item.get("replica Jurassic Parka");
    case import_kolmafia26.Item.get("Cincho de Mayo"):
      return import_kolmafia26.Item.get("replica Cincho de Mayo");
    case import_kolmafia26.Item.get("2002 Mr. Store Catalog"):
      return import_kolmafia26.Item.get("Replica 2002 Mr. Store Catalog");
    case import_kolmafia26.Item.get("august scepter"):
      return import_kolmafia26.Item.get("replica august scepter");
  }
  return it;
}
...
function in_lar() {
  return (0, import_kolmafia27.myPath)() === import_kolmafia27.Path.get("Live. Ascend. Repeat.");
}
...
function spookyForestChoiceHandler(choice) {
  if (choice === 502) {
    if (internalQuestStatus("questL02Larva") === 0 && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("mosquito larva")) === 0) {
      (0, import_kolmafia28.runChoice)(2);
    } else if (!(0, import_kolmafia28.hiddenTempleUnlocked)()) {
      if ((0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("tree-holed coin")) === 0 && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("Spooky Temple map")) === 0) {
        (0, import_kolmafia28.runChoice)(2);
      } else if ((0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("Spooky Temple map")) === 0 || (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("Spooky-Gro fertilizer")) === 0) {
        (0, import_kolmafia28.runChoice)(3);
      } else {
    ...
    if ((0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("bar skin")) > 1) {
      (0, import_kolmafia28.runChoice)(2);
    } else if ((0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("bar skin")) === 1) {
      (0, import_kolmafia28.runChoice)(1);
    }
    if (!(0, import_kolmafia28.hiddenTempleUnlocked)() && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("spooky sapling")) === 0 && (0, import_kolmafia28.myMeat)() > 100) {
      (0, import_kolmafia28.runChoice)(3);
    }
    (0, import_kolmafia28.runChoice)(4);
  } else if (choice === 505) {
    if (internalQuestStatus("questL02Larva") === 0 && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("mosquito larva")) === 0) {
      (0, import_kolmafia28.runChoice)(1);
    } else {
    ...
    if (!(0, import_kolmafia28.hiddenTempleUnlocked)() && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("Spooky-Gro fertilizer")) === 0) {
      (0, import_kolmafia28.runChoice)(2);
    } else {
      (0, import_kolmafia28.runChoice)(3);
    }
  } else if (choice === 507) {
    if (!(0, import_kolmafia28.hiddenTempleUnlocked)() && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("tree-holed coin")) > 0 && (0, import_kolmafia28.itemAmount)(import_kolmafia28.Item.get("Spooky Temple map")) === 0) {
      (0, import_kolmafia28.runChoice)(1);
    } else {
      (0, import_kolmafia28.runChoice)(3);
    }
  } else {
    (0, import_kolmafia28.abort)("unhandled choice in spookyForestChoiceHandler");
  }
}
...
function in_nuclear() {
  return (0, import_kolmafia29.myPath)() === import_kolmafia29.Path.get("Nuclear Autumn");
}
...
function in_pokefam() {
  return (0, import_kolmafia32.myPath)() === import_kolmafia32.Path.get("Pocket Familiars");
}

// src/autoscend/paths/quantum_terrarium.ts
var import_kolmafia33 = require("kolmafia");
function in_quantumTerrarium() {
  return (0, import_kolmafia33.myPath)() === import_kolmafia33.Path.get("Quantum Terrarium");
}

// src/autoscend/paths/small.ts
var import_kolmafia34 = require("kolmafia");
function in_small() {
  return (0, import_kolmafia34.myPath)() === import_kolmafia34.Path.get("A Shrunken Adventurer am I");
}

// src/autoscend/paths/two_crazy_random_summer.ts
var import_kolmafia35 = require("kolmafia");
function in_tcrs() {
  return (0, import_kolmafia35.myPath)() === import_kolmafia35.Path.get("Two Crazy Random Summer");
}

// src/autoscend/paths/way_of_the_surprising_fist.ts
var import_kolmafia36 = require("kolmafia");
function in_wotsf() {
  return (0, import_kolmafia36.myPath)() === import_kolmafia36.Path.get("Way of the Surprising Fist");
}

// src/autoscend/paths/wildfire.ts
var import_kolmafia37 = require("kolmafia");
function in_wildfire() {
  return (0, import_kolmafia37.myPath)() === import_kolmafia37.Path.get("Wildfire");
}
...
function castleBasementChoiceHandler(choice) {
  if (choice === 669) {
    (0, import_kolmafia40.runChoice)(1);
  } else if (choice === 670) {
    if (internalQuestStatus("questL10Garbage") < 8 && (0, import_kolmafia40.equippedAmount)(import_kolmafia40.Item.get("amulet of extreme plot significance")) > 0) {
      (0, import_kolmafia40.runChoice)(4);
    } else {
      (0, import_kolmafia40.runChoice)(1);
    }
  } else if (choice === 671) {
    if ((0, import_kolmafia40.itemAmount)(import_kolmafia40.Item.get("massive dumbbell")) > 0) {
      (0, import_kolmafia40.runChoice)(1);
    } else {
      (0, import_kolmafia40.runChoice)(4);
    }
  } else {
    (0, import_kolmafia40.abort)("unhandled choice in castleBasementChoiceHandler");
  }
}
function castleTopFloorChoiceHandler(choice) {
  if (choice === 675) {
    if (internalQuestStatus("questL10Garbage") < 10 && (0, import_kolmafia40.itemAmount)(import_kolmafia40.Item.get("drum 'n' bass 'n' drum 'n' bass record")) > 0) {
      (0, import_kolmafia40.runChoice)(2);
    } else if (in_koe() && (0, import_kolmafia40.itemAmount)(import_kolmafia40.Item.get("model airship")) === 0) {
      (0, import_kolmafia40.runChoice)(1);
    } else {
      (0, import_kolmafia40.runChoice)(4);
    }
  } else if (choice === 676) {
    if ((0, import_kolmafia40.equippedAmount)(import_kolmafia40.Item.get("Mohawk wig")) > 0 || internalQuestStatus("questL10Garbage") >= 10) {
      (0, import_kolmafia40.runChoice)(4);
    } else {
      (0, import_kolmafia40.runChoice)(3);
    }
  } else if (choice === 677) {
    if (internalQuestStatus("questL10Garbage") < 10 && (0, import_kolmafia40.itemAmount)(import_kolmafia40.Item.get("model airship")) > 0) {
      (0, import_kolmafia40.runChoice)(1);
    } else if (internalQuestStatus("questL10Garbage") < 10 && (0, import_kolmafia40.itemAmount)(import_kolmafia40.Item.get("drum 'n' bass 'n' drum 'n' bass record")) > 0 || in_koe()) {
      (0, import_kolmafia40.runChoice)(4);
    } else {
      (0, import_kolmafia40.runChoice)(2);
    }
  } else if (choice === 678) {
    if (internalQuestStatus("questL10Garbage") < 10 && (0, import_kolmafia40.equippedAmount)(import_kolmafia40.Item.get("Mohawk wig")) > 0) {
      (0, import_kolmafia40.runChoice)(1);
    ...
    (0, import_kolmafia40.abort)("unhandled choice in castleTopFloorChoiceHandler");
  }
}
function L10_needUmbrella() {
  var _iterator = _createForOfIteratorHelper(
    import_kolmafia40.Item.get(["titanium assault umbrella", "unbreakable umbrella"])
  ), _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var it = _step.value;
      if (auto_is_valid(it) && (0, import_kolmafia40.availableAmount)(it) > 0) {
        return false;
      }
    }
  } catch (err) {
...
function oldLandfillChoiceHandler(choice) {
  if (choice === 794) {
    if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("junk junk")) === 0) {
      if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("old claw-foot bathtub")) === 0) {
        (0, import_kolmafia42.runChoice)(1);
      } else if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("old clothesline pole")) === 0) {
        (0, import_kolmafia42.runChoice)(2);
      } else if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("antique cigar sign")) === 0) {
        (0, import_kolmafia42.runChoice)(3);
      } else {
        (0, import_kolmafia42.runChoice)(1);
      }
    } else {
      if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("tangle of copper wire")) === 0) {
        (0, import_kolmafia42.runChoice)(2);
      } else if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("Junk-Bond")) === 0) {
        (0, import_kolmafia42.runChoice)(3);
      } else {
        (0, import_kolmafia42.runChoice)(1);
      }
    ...
    if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("old clothesline pole")) === 0) {
      (0, import_kolmafia42.runChoice)(2);
    } else {
      (0, import_kolmafia42.runChoice)(3);
    }
  } else if (choice === 797) {
    if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("antique cigar sign")) === 0) {
      (0, import_kolmafia42.runChoice)(3);
    } else {
      (0, import_kolmafia42.runChoice)(1);
    }
  } else {
    (0, import_kolmafia42.abort)("unhandled choice in oldLandfillChoiceHandler");
  }
}
function dailyDungeonChoiceHandler(choice, options) {
  switch (choice) {
    ...
    case 691:
      if (options.has(4)) {
        (0, import_kolmafia42.runChoice)(4);
        if (options.has(2)) {
          (0, import_kolmafia42.runChoice)(2);
        } else {
          (0, import_kolmafia42.runChoice)(3);
    ...
    case 692:
      if (options.has(3)) {
        ...
        (0, import_kolmafia42.runChoice)(7);
      } else if ((0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("skeleton key")) > 1 || (0, import_kolmafia42.itemAmount)(import_kolmafia42.Item.get("skeleton key")) > 0 && (0, import_kolmafia42.containsText)((0, import_kolmafia42.getProperty)("nsTowerDoorKeysUsed"), import_kolmafia42.Item.get("skeleton key").toString())) {
        (0, import_kolmafia42.runChoice)(2);
      } else if ((0, import_kolmafia42.myPrimestat)() === import_kolmafia42.Stat.get("Muscle") && (0, import_kolmafia42.myBuffedstat)(import_kolmafia42.Stat.get("Muscle")) >= 30) {
        (0, import_kolmafia42.runChoice)(4);
      } else if ((0, import_kolmafia42.myPrimestat)() === import_kolmafia42.Stat.get("Mysticality") && (0, import_kolmafia42.myBuffedstat)(import_kolmafia42.Stat.get("Mysticality")) >= 30) {
        (0, import_kolmafia42.runChoice)(5);
      } else if ((0, import_kolmafia42.myPrimestat)() === import_kolmafia42.Stat.get("Moxie") && (0, import_kolmafia42.myBuffedstat)(import_kolmafia42.Stat.get("Moxie")) >= 30) {
        (0, import_kolmafia42.runChoice)(6);
      } else {
        (0, import_kolmafia42.abort)("I made an error and tried to adventure in the daily dungeon when I have no means of handling [I Wanna Be a Door]");
      }
      break;
    case 693:
      if (options.has(4)) {
      ...
      break;
    default:
      (0, import_kolmafia42.abort)("unhandled choice in dailyDungeonChoiceHandler");
      break;
  }
}
...
function in_lta() {
  return (0, import_kolmafia44.myPath)() === import_kolmafia44.Path.get("License to Adventure");
}
...
function piratesCoveChoiceHandler(choice) {
  if (choice === 22) {
    if (possessEquipment(import_kolmafia45.Item.get("eyepatch"))) {
      if (possessEquipment(import_kolmafia45.Item.get("swashbuckling pants"))) {
    ...
    if (possessEquipment(import_kolmafia45.Item.get("stuffed shoulder parrot"))) {
      if (possessEquipment(import_kolmafia45.Item.get("swashbuckling pants"))) {
        (0, import_kolmafia45.runChoice)(3);
      } else {
        (0, import_kolmafia45.runChoice)(2);
...
function barrrneysBarrrChoiceHandler(choice) {
  ...
  if (choice === 184) {
    if ((0, import_kolmafia45.myPrimestat)() === import_kolmafia45.Stat.get("Mysticality")) {
      (0, import_kolmafia45.runChoice)(3);
    } else {
      (0, import_kolmafia45.runChoice)(1);
    }
    ...
    if ((0, import_kolmafia45.myPrimestat)() === import_kolmafia45.Stat.get("Moxie")) {
      (0, import_kolmafia45.runChoice)(3);
    } else {
      (0, import_kolmafia45.runChoice)(1);
    }
...
function fcleChoiceHandler(choice) {
  if (choice === 191) {
    if ((0, import_kolmafia45.itemAmount)(import_kolmafia45.Item.get("valuable trinket")) > 0) {
      (0, import_kolmafia45.runChoice)(2);
    } else {
      switch ((0, import_kolmafia45.myPrimestat)()) {
        case import_kolmafia45.Stat.get("Muscle"):
          (0, import_kolmafia45.runChoice)(3);
          break;
        case import_kolmafia45.Stat.get("Mysticality"):
          (0, import_kolmafia45.runChoice)(4);
          break;
        case import_kolmafia45.Stat.get("Moxie"):
          (0, import_kolmafia45.runChoice)(1);
          break;
      }
    }
...
$_f_epicWeapons ?? ($_f_epicWeapons = /* @__PURE__ */ new Map(
  [
    [import_kolmafia45.Class.get("Seal Clubber"), import_kolmafia45.Item.get("Hammer of Smiting")],
    [import_kolmafia45.Class.get("Turtle Tamer"), import_kolmafia45.Item.get("Chelonian Morningstar")],
    [import_kolmafia45.Class.get("Pastamancer"), import_kolmafia45.Item.get("Greek Pasta Spoon of Peril")],
    [import_kolmafia45.Class.get("Sauceror"), import_kolmafia45.Item.get("17-alarm Saucepan")],
    [import_kolmafia45.Class.get("Disco Bandit"), import_kolmafia45.Item.get("Shagadelic Disco Banjo")],
    [import_kolmafia45.Class.get("Accordion Thief"), import_kolmafia45.Item.get("Squeezebox of the Ages")]
  ]
));
var $_f_starterWeapons;
$_f_starterWeapons ?? ($_f_starterWeapons = /* @__PURE__ */ new Map(
  [
    [import_kolmafia45.Class.get("Seal Clubber"), import_kolmafia45.Item.get("seal-clubbing club")],
    [import_kolmafia45.Class.get("Turtle Tamer"), import_kolmafia45.Item.get("turtle totem")],
    [import_kolmafia45.Class.get("Pastamancer"), import_kolmafia45.Item.get("pasta spoon")],
    [import_kolmafia45.Class.get("Sauceror"), import_kolmafia45.Item.get("saucepan")],
    [import_kolmafia45.Class.get("Disco Bandit"), import_kolmafia45.Item.get("disco ball")],
    [import_kolmafia45.Class.get("Accordion Thief"), import_kolmafia45.Item.get("stolen accordion")]
  ]
));

// src/autoscend/paths/you_robot.ts
function in_robot() {
  return (0, import_kolmafia46.myPath)() === import_kolmafia46.Path.get("You, Robot");
}
function robot_cpu(choice, want_buy) {
  ...
  switch (choice) {
    ...
    case 12:
      ...
      break;
    default:
      (0, import_kolmafia46.abort)(`boolean robot_cpu(int choice) does not recognize the choice: ${choice}`);
  }
  if ((0, import_kolmafia46.containsText)((0, import_kolmafia46.getProperty)("youRobotCPUUpgrades"), upgrade)) {
    return true;
  } else if (!want_buy) {
    return false;
  }
  if ((0, import_kolmafia46.myRobotEnergy)() < energy_cost) {
    return false;
  }
  var starting_energy = (0, import_kolmafia46.myRobotEnergy)();
  auto_log_info$1(`Upgrading CPU with ${name}`);
  (0, import_kolmafia46.visitUrl)("place.php?whichplace=scrapheap&action=sh_configure");
  (0, import_kolmafia46.visitUrl)("choice.php?whichchoice=1445&show=cpus");
  (0, import_kolmafia46.visitUrl)(`choice.php?pwd&whichchoice=1445&part=cpus&show=cpus&option=2&p=${upgrade}`);
  if ((0, import_kolmafia46.myRobotEnergy)() !== starting_energy - energy_cost) {
    (0, import_kolmafia46.abort)(`Mysteriously failed to upgrade the CPU with ${choice}. Beep Boop.`);
  }
  return true;
}
function robot_choice_adv(choice, page) {
  ...
  auto_log_debug$1("Running robot_choice_adv");
  {
    ...
    switch (choice) {
      case 876:
        robot_need_mus = (0, import_kolmafia46.myPrimestat)() === import_kolmafia46.Stat.get("Muscle") || (0, import_kolmafia46.myBasestat)(import_kolmafia46.Stat.get("Muscle")) < 62;
        if ((0, import_kolmafia46.myMeat)() < 1e3 + meatReserve() && auto_is_valid(import_kolmafia46.Item.get("old leather wallet")) && !robot_need_mus) {
          (0, import_kolmafia46.runChoice)(1);
        } else if ((0, import_kolmafia46.itemAmount)(import_kolmafia46.Item.get("ghost key")) > 0 && (0, import_kolmafia46.myPrimestat)() === import_kolmafia46.Stat.get("Muscle")) {
        ...
        break;
      case 878:
        robot_need_mys = (0, import_kolmafia46.myPrimestat)() === import_kolmafia46.Stat.get("Mysticality") || (0, import_kolmafia46.myBasestat)(import_kolmafia46.Stat.get("Mysticality")) < 70;
        needSpectacles = (0, import_kolmafia46.itemAmount)(import_kolmafia46.Item.get("Lord Spookyraven's spectacles")) === 0 && internalQuestStatus("questL11Manor") < 2;
        if (needSpectacles) {
          (0, import_kolmafia46.runChoice)(3);
        } else if ((0, import_kolmafia46.itemAmount)(import_kolmafia46.Item.get("disposable instant camera")) === 0 && internalQuestStatus("questL11Palindome") < 1) {
          (0, import_kolmafia46.runChoice)(4);
        } else if (!robot_need_mys || (0, import_kolmafia46.myMeat)() < 1e3 + meatReserve()) {
          (0, import_kolmafia46.runChoice)(1);
        } else if ((0, import_kolmafia46.itemAmount)(import_kolmafia46.Item.get("ghost key")) > 0 && (0, import_kolmafia46.myPrimestat)() === import_kolmafia46.Stat.get("Mysticality")) {
        ...
        break;
      case 879:
        options = new Map(Object.entries((0, import_kolmafia46.availableChoiceOptions)()).map((_ref) => {
          var _ref2 = _slicedToArray(_ref, 2), _k = _ref2[0], _v = _ref2[1];
          return [(0, import_kolmafia46.toInt)(_k), _v];
        }));
        if (options.has(4)) {
          (0, import_kolmafia46.runChoice)(4);
        } else if ((0, import_kolmafia46.itemAmount)(import_kolmafia46.Item.get("ghost key")) > 0 && (0, import_kolmafia46.myPrimestat)() === import_kolmafia46.Stat.get("Moxie")) {
          (0, import_kolmafia46.runChoice)(5);
        } else {
          (0, import_kolmafia46.runChoice)(1);
        }
...
function in_zombieSlayer() {
  return (0, import_kolmafia47.myPath)() === import_kolmafia47.Path.get("Zombie Slayer");
}
function zombieSlayer_usable(fam) {
  if (!in_zombieSlayer()) {
    return true;
  }
  return (0, import_kolmafia47.containsText)(fam.attributes, "undead");
}
...
function cyrptChoiceHandler(choice) {
  if (choice === 153) {
    ...
    if (in_zombieSlayer() && ((0, import_kolmafia48.itemAmount)(import_kolmafia48.Item.get("talkative skull")) === 0 || !(0, import_kolmafia48.haveFamiliar)(import_kolmafia48.Familiar.get("Hovering Skull")))) {
      (0, import_kolmafia48.runChoice)(1);
    } else {
      (0, import_kolmafia48.runChoice)(5);
    }
  } else if (choice === 157) {
    (0, import_kolmafia48.runChoice)(4);
  } else if (choice === 523) {
    if (in_darkGyffte() && (0, import_kolmafia48.haveSkill)(import_kolmafia48.Skill.get("Flock of Bats Form")) && (0, import_kolmafia48.haveSkill)(import_kolmafia48.Skill.get("Sharp Eyes")) || auto_turbo()) {
      var desiredPills = (0, import_kolmafia48.inHardcore)() ? 6 : auto_turbo() ? 3 : 4;
      var dietingPillsUsed = 0;
      if ((0, import_kolmafia48.getProperty)("auto_chewed") === "") {
        dietingPillsUsed = 0;
      } else {
        var _iterator = _createForOfIteratorHelper(
          (0, import_kolmafia48.splitString)((0, import_kolmafia48.getProperty)("auto_chewed"), ",")
        ), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            var str = _step.value;
            if ((0, import_kolmafia48.containsText)((0, import_kolmafia48.toLowerCase)(str), "dieting pill")) {
              dietingPillsUsed += 1;
            }
          }
        } catch (err) {
      ...
      if (!auto_turbo()) {
        desiredPills -= (0, import_kolmafia48.myFullness)() / 2;
      } else {
        desiredPills -= dietingPillsUsed;
      }
      auto_log_info(`We want ${desiredPills} dieting pills and have ${(0, import_kolmafia48.itemAmount)(import_kolmafia48.Item.get("dieting pill"))}`, "blue");
      if ((0, import_kolmafia48.itemAmount)(import_kolmafia48.Item.get("dieting pill")) < desiredPills) {
        (0, import_kolmafia48.runChoice)(6);
      } else if (5 in (0, import_kolmafia48.availableChoiceOptions)()) {
        (0, import_kolmafia48.runChoice)(5);
      } else {
        (0, import_kolmafia48.runChoice)(4);
      }
    ...
    (0, import_kolmafia48.abort)("unhandled choice in cyrptChoiceHandler");
  }
}
...
function hauntedBedroomChoiceHandler(choice, options) {
  if (choice === 876) {
    if ((0, import_kolmafia50.myMeat)() < 1e3 + meatReserve() && auto_is_valid(import_kolmafia50.Item.get("old leather wallet")) && !in_wotsf() || in_amw()) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("ghost key")) > 0 && (0, import_kolmafia50.myPrimestat)() === import_kolmafia50.Stat.get("Muscle") && (0, import_kolmafia50.myBuffedstat)(import_kolmafia50.Stat.get("Muscle")) < 150) {
      (0, import_kolmafia50.runChoice)(3);
    } else {
      (0, import_kolmafia50.runChoice)(2);
    }
  } else if (choice === 877) {
    (0, import_kolmafia50.runChoice)(1);
  } else if (choice === 878) {
    var needSpectacles = !possessEquipment(import_kolmafia50.Item.get("Lord Spookyraven's spectacles")) && internalQuestStatus("questL11Manor") < 2;
    if (is_boris() || in_wotsf() || in_nuclear() && (0, import_kolmafia50.inHardcore)()) {
      needSpectacles = false;
    }
    if (needSpectacles) {
      (0, import_kolmafia50.runChoice)(3);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("disposable instant camera")) === 0 && internalQuestStatus("questL11Palindome") < 1) {
      (0, import_kolmafia50.runChoice)(4);
    } else if ((0, import_kolmafia50.myPrimestat)() !== import_kolmafia50.Stat.get("Mysticality") || (0, import_kolmafia50.myMeat)() < 1e3 + meatReserve() || in_amw()) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("ghost key")) > 0 && (0, import_kolmafia50.myPrimestat)() === import_kolmafia50.Stat.get("Mysticality") && (0, import_kolmafia50.myBuffedstat)(import_kolmafia50.Stat.get("Mysticality")) < 150) {
    ...
    if (in_bhy() && (0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("antique hand mirror")) < 1) {
      (0, import_kolmafia50.runChoice)(3);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("ghost key")) > 0 && (0, import_kolmafia50.myPrimestat)() === import_kolmafia50.Stat.get("Moxie") && (0, import_kolmafia50.myBuffedstat)(import_kolmafia50.Stat.get("Moxie")) < 150) {
      (0, import_kolmafia50.runChoice)(5);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    }
  } else if (choice === 880) {
    if (internalQuestStatus("questM21Dance") < 2 && (0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("Lady Spookyraven's finest gown")) === 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else {
      (0, import_kolmafia50.runChoice)(2);
    }
  } else {
    (0, import_kolmafia50.abort)("unhandled choice in hauntedBedroomChoiceHandler");
  }
}
function blackForestChoiceHandler(choice) {
  if (choice === 923) {
    if (5 in (0, import_kolmafia50.availableChoiceOptions)()) {
      (0, import_kolmafia50.runChoice)(5);
      (0, import_kolmafia50.runChoice)(1);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    ...
    if ((0, import_kolmafia50.toBoolean)((0, import_kolmafia50.getProperty)("auto_getBeehive")) && (0, import_kolmafia50.myAdventures)() > 3) {
      (0, import_kolmafia50.runChoice)(3);
    } else if (!possessEquipment(import_kolmafia50.Item.get("blackberry galoshes")) && (0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("blackberry")) >= 3 && !in_darkGyffte()) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    }
    ...
    if (!possessEquipment(import_kolmafia50.Item.get("blackberry galoshes")) && (0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("blackberry")) >= 3 && !in_darkGyffte()) {
      (0, import_kolmafia50.runChoice)(4);
    } else {
      (0, import_kolmafia50.runChoice)(5);
    }
  } else if (choice === 1018) {
    if ((0, import_kolmafia50.toBoolean)((0, import_kolmafia50.getProperty)("auto_getBeehive")) && (0, import_kolmafia50.myAdventures)() > 2) {
      (0, import_kolmafia50.runChoice)(1);
    } else {
      (0, import_kolmafia50.runChoice)(2);
    }
  } else if (choice === 1019) {
    if ((0, import_kolmafia50.toBoolean)((0, import_kolmafia50.getProperty)("auto_getBeehive"))) {
      (0, import_kolmafia50.runChoice)(1);
    } else {
      (0, import_kolmafia50.runChoice)(2);
    }
  } else {
    (0, import_kolmafia50.abort)("unhandled choice in blackForestChoiceHandler");
  }
}
function hiddenTempleChoiceHandler(choice, page) {
  if (choice === 123) {
    (0, import_kolmafia50.runChoice)(2);
    (0, import_kolmafia50.visitUrl)("choice.php");
    (0, import_kolmafia50.cliExecute)("dvorak");
  } else if (choice === 125) {
    (0, import_kolmafia50.runChoice)(3);
  } else if (choice === 579) {
    if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("stone wool")) >= 2 && (0, import_kolmafia50.toInt)((0, import_kolmafia50.getProperty)("lastTempleAdventures")) < (0, import_kolmafia50.myAscensions)()) {
      (0, import_kolmafia50.runChoice)(3);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("the Nostril of the Serpent")) === 0 && internalQuestStatus("questL11Worship") < 3) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(3);
    }
  } else if (choice === 580) {
    if (!(0, import_kolmafia50.containsText)(page, "The door is decorated with that little lightning-tailed guy from your father's diary.")) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    }
    ...
    if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("the Nostril of the Serpent")) > 0 && internalQuestStatus("questL11Worship") < 3) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    }
    ...
    (0, import_kolmafia50.abort)("unhandled choice in hiddenTempleChoiceHandler");
  }
}
function hiddenCityChoiceHandler(choice) {
  if (choice === 780) {
    if ((0, import_kolmafia50.haveEffect)(import_kolmafia50.Effect.get("Thrice-Cursed")) > 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else if (4 in (0, import_kolmafia50.availableChoiceOptions)() && (0, import_kolmafia50.haveEffect)(import_kolmafia50.Effect.get("Thrice-Cursed")) === 0) {
      (0, import_kolmafia50.runChoice)(4);
      if ((0, import_kolmafia50.haveEffect)(import_kolmafia50.Effect.get("Thrice-Cursed")) > 0) {
        (0, import_kolmafia50.runChoice)(1);
      } else {
    ...
    if ((0, import_kolmafia50.toInt)((0, import_kolmafia50.getProperty)("hiddenApartmentProgress")) === 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("moss-covered stone sphere")) > 0) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(6);
    }
  } else if (choice === 783) {
    if ((0, import_kolmafia50.toInt)((0, import_kolmafia50.getProperty)("hiddenHospitalProgress")) === 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("dripping stone sphere")) > 0) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(6);
    }
    ...
    if ((0, import_kolmafia50.toInt)((0, import_kolmafia50.getProperty)("hiddenOfficeProgress")) === 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(
      // either use CCSC + unlock or just unlock based on user sphere presence
      import_kolmafia50.Item.get("crackling stone sphere")
    ) > 0) {
      if (4 in (0, import_kolmafia50.availableChoiceOptions)()) {
        (0, import_kolmafia50.runChoice)(4);
      }
      (0, import_kolmafia50.runChoice)(2);
    } else {
    ...
    if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("McClusky file (complete)")) > 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("boring binder clip")) === 0) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(3);
    }
  } else if (choice === 787) {
    if ((0, import_kolmafia50.toInt)((0, import_kolmafia50.getProperty)("hiddenBowlingAlleyProgress")) === 0) {
      (0, import_kolmafia50.runChoice)(1);
    } else if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("scorched stone sphere")) > 0) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(6);
    }
  } else if (choice === 788) {
    if (2 in (0, import_kolmafia50.availableChoiceOptions)()) {
      (0, import_kolmafia50.runChoice)(2);
      (0, import_kolmafia50.runChoice)(1);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    ...
    if ((0, import_kolmafia50.toInt)((0, import_kolmafia50.getProperty)("relocatePygmyJanitor")) !== (0, import_kolmafia50.myAscensions)()) {
      (0, import_kolmafia50.runChoice)(2);
    } else {
      (0, import_kolmafia50.runChoice)(1);
    }
  } else if (choice === 791) {
    if ((0, import_kolmafia50.itemAmount)(import_kolmafia50.Item.get("stone triangle")) === 4) {
      (0, import_kolmafia50.runChoice)(1);
    } else {
      (0, import_kolmafia50.runChoice)(6);
    }
    ...
    (0, import_kolmafia50.abort)("unhandled choice in hiddenCityChoiceHandler");
  }
}

// src/autoscend/paths/low_key_summer.ts
var lowKeys = /* @__PURE__ */ new Map();
lowKeys.set(import_kolmafia52.Item.get("clown car key"), import_kolmafia52.Location.get('The "Fun" House'));
lowKeys.set(import_kolmafia52.Item.get("batting cage key"), import_kolmafia52.Location.get("The Bat Hole Entrance"));
lowKeys.set(import_kolmafia52.Item.get("aqu&iacute;"), import_kolmafia52.Location.get("South of the Border"));
lowKeys.set(import_kolmafia52.Item.get("knob labinet key"), import_kolmafia52.Location.get("Cobb's Knob Laboratory"));
lowKeys.set(import_kolmafia52.Item.get("weremoose key"), import_kolmafia52.Location.get("Cobb's Knob Menagerie, Level 2"));
lowKeys.set(import_kolmafia52.Item.get("peg key"), import_kolmafia52.Location.get("The Obligatory Pirate's Cove"));
lowKeys.set(import_kolmafia52.Item.get("kekekey"), import_kolmafia52.Location.get("The Valley of Rof L'm Fao"));
lowKeys.set(import_kolmafia52.Item.get("rabbit's foot key"), import_kolmafia52.Location.get("The Dire Warren"));
lowKeys.set(import_kolmafia52.Item.get("knob shaft skate key"), import_kolmafia52.Location.get("The Knob Shaft"));
lowKeys.set(import_kolmafia52.Item.get("ice key"), import_kolmafia52.Location.get("The Icy Peak"));
lowKeys.set(import_kolmafia52.Item.get("anchovy can key"), import_kolmafia52.Location.get("The Haunted Pantry"));
lowKeys.set(import_kolmafia52.Item.get("cactus key"), import_kolmafia52.Location.get("The Arid, Extra-Dry Desert"));
lowKeys.set(import_kolmafia52.Item.get("f'c'le sh'c'le k'y"), import_kolmafia52.Location.get("The F'c'le"));
lowKeys.set(import_kolmafia52.Item.get("treasure chest key"), import_kolmafia52.Location.get("Belowdecks"));
lowKeys.set(import_kolmafia52.Item.get("demonic key"), import_kolmafia52.Location.get("Pandamonium Slums"));
lowKeys.set(import_kolmafia52.Item.get("key sausage"), import_kolmafia52.Location.get("Cobb's Knob Kitchens"));
lowKeys.set(import_kolmafia52.Item.get("knob treasury key"), import_kolmafia52.Location.get("Cobb's Knob Treasury"));
lowKeys.set(import_kolmafia52.Item.get("scrap metal key"), import_kolmafia52.Location.get("The Old Landfill"));
lowKeys.set(import_kolmafia52.Item.get("black rose key"), import_kolmafia52.Location.get("The Haunted Conservatory"));
lowKeys.set(import_kolmafia52.Item.get("actual skeleton key"), import_kolmafia52.Location.get("The Skeleton Store"));
lowKeys.set(import_kolmafia52.Item.get("music box key"), import_kolmafia52.Location.get("The Haunted Nursery"));
lowKeys.set(import_kolmafia52.Item.get("deep-fried key"), import_kolmafia52.Location.get("Madness Bakery"));
lowKeys.set(import_kolmafia52.Item.get("discarded bike lock key"), import_kolmafia52.Location.get("The Overgrown Lot"));
...
// src/autoscend/paths/kingdom_of_exploathing.ts
function in_koe() {
  return (0, import_kolmafia55.myPath)() === import_kolmafia55.Path.get("Kingdom of Exploathing");
}
function koe_L12FoodSelect() {
  var food_item = import_kolmafia55.Item.none;
  var _iterator4 = _createForOfIteratorHelper(
    import_kolmafia55.Item.get(["pie man was not meant to eat", "spaghetti with Skullheads", "gnocchetti di Nietzsche", "spaghetti con calaveras", "space chowder", "spaghetti with ghost balls", "crudles", "agnolotti arboli", "shells a la shellfish", "linguini immondizia bianco", "fettucini Inconnu", "ghuol guolash", "suggestive strozzapreti", "fusilli marrownarrow"])
  ), _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
      var it = _step4.value;
      if ((0, import_kolmafia55.itemAmount)(it) > 0) {
        food_item = it;
        break;
      }
    }
...
function koe_RationingOutDestruction() {
  ...
  if (food_item === import_kolmafia55.Item.none) {
    (0, import_kolmafia55.abort)("I am at the choice adventure and do not know what food I should kill my enemies with during L12 war quest");
  }
  (0, import_kolmafia55.runChoice)(1, `tossid=${(0, import_kolmafia55.toInt)(food_item)}`);
}
...
function have_fireworks_shop() {
  ...
  if ((0, import_kolmafia56.itemAmount)(import_kolmafia56.Item.get("Clan VIP Lounge key")) === 0) {
    return false;
  }
  if (!auto_is_valid(import_kolmafia56.Item.get("clan underground fireworks shop"))) {
    return false;
  }
  return (0, import_kolmafia56.toBoolean)((0, import_kolmafia56.getProperty)("_fireworksShop"));
}

// src/autoscend/paths/i_love_u_hate.ts
var import_kolmafia57 = require("kolmafia");
function in_iluh() {
  return (0, import_kolmafia57.myPath)() === import_kolmafia57.Path.get("11 Things I Hate About U");
}
function iluh_foodConsumable(str) {
  if (!in_iluh()) {
    return true;
  }
  var foodConsume = (0, import_kolmafia57.toLowerCase)(str);
  if ((0, import_kolmafia57.containsText)(foodConsume, "stunt nut") || (0, import_kolmafia57.containsText)(foodConsume, "wet stew") || (0, import_kolmafia57.containsText)(foodConsume, "wet stunt nut stew")) {
    return true;
  }
  if ((0, import_kolmafia57.containsText)(foodConsume, "u")) {
    return false;
  }
  if ((0, import_kolmafia57.containsText)(foodConsume, "i")) {
    return true;
  }
  return false;
}
function iluh_famAllowed(fam) {
  ...
  if ((0, import_kolmafia57.containsText)((0, import_kolmafia57.toLowerCase)(fam), "u")) {
    return false;
  }
  return true;
}
...
function haveWarOutfit(canWear) {
  if (!(0, import_kolmafia61.toBoolean)((0, import_kolmafia61.getProperty)("auto_hippyInstead"))) {
...
function in_darkGyffte() {
  return (0, import_kolmafia62.myPath)() === import_kolmafia62.Path.get("Dark Gyffte");
}
function bat_maxHPCost(sk) {
  switch (sk) {
    case import_kolmafia62.Skill.get("Baleful Howl"):
    case import_kolmafia62.Skill.get("Intimidating Aura"):
    case import_kolmafia62.Skill.get("Mist Form"):
    case import_kolmafia62.Skill.get("Sharp Eyes"):
      return 30;
    case import_kolmafia62.Skill.get("Madness of Untold Aeons"):
      return 25;
    case import_kolmafia62.Skill.get("Crush"):
    case import_kolmafia62.Skill.get("Wolf Form"):
    case import_kolmafia62.Skill.get("Blood Spike"):
    case import_kolmafia62.Skill.get("Blood Cloak"):
    case import_kolmafia62.Skill.get("Macabre Cunning"):
    case import_kolmafia62.Skill.get("Piercing Gaze"):
    case import_kolmafia62.Skill.get("Ensorcel"):
    case import_kolmafia62.Skill.get("Flock of Bats Form"):
      return 20;
    case import_kolmafia62.Skill.get("Ceaseless Snarl"):
    case import_kolmafia62.Skill.get("Preternatural Strength"):
    case import_kolmafia62.Skill.get("Blood Chains"):
    case import_kolmafia62.Skill.get("Sanguine Magnetism"):
    case import_kolmafia62.Skill.get("Perceive Soul"):
    case import_kolmafia62.Skill.get("Sinister Charm"):
    case import_kolmafia62.Skill.get("Batlike Reflexes"):
    case import_kolmafia62.Skill.get("Spot Weakness"):
      return 15;
    case import_kolmafia62.Skill.get("Savage Bite"):
    case import_kolmafia62.Skill.get("[24017]Ferocity"):
    case import_kolmafia62.Skill.get("Chill of the Tomb"):
    case import_kolmafia62.Skill.get("Spectral Awareness"):
      return 10;
    case import_kolmafia62.Skill.get("Flesh Scent"):
    case import_kolmafia62.Skill.get("Hypnotic Eyes"):
      return 5;
    default:
      return 0;
  }
...
function bat_baseHP() {
  return 20 * (0, import_kolmafia62.min)(23, (0, import_kolmafia62.toInt)((0, import_kolmafia62.getProperty)("darkGyfftePoints"))) + (0, import_kolmafia62.myBasestat)(import_kolmafia62.Stat.get("Muscle")) + 20;
}
function bat_desiredSkills$1(hpLeft, forcedPicks) {
  var costSoFar = 0;
  var baseHP = bat_baseHP();
  var picks = /* @__PURE__ */ new Map();
  if ((0, import_kolmafia62.getProperty)("_auto_bat_bloodBank") !== "2") {
    forcedPicks.set(import_kolmafia62.Skill.get("Intimidating Aura"), true);
  }
...
function bat_reallyPickSkills$1(hpLeft, requiredSkills) {
  if (!in_darkGyffte() && (0, import_kolmafia62.myClass)().toString() !== "Astral Spirit") {
    return;
  }
  (0, import_kolmafia62.visitUrl)("campground.php?action=coffin");
  var picks = bat_desiredSkills$1(hpLeft, requiredSkills);
  var url = `choice.php?whichchoice=1342&option=2&pwd=${(0, import_kolmafia62.myHash)()}`;
  ...
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
      ...
      url += "&sk[]=";
      url += ((0, import_kolmafia62.toInt)(sk) - 24e3).toString();
    }
  } catch (err) {
    _iterator6.e(err);
  } finally {
  ...
  (0, import_kolmafia62.visitUrl)(url);
  (0, import_kolmafia62.visitUrl)(`choice.php?whichchoice=1342&option=1&pwd=${(0, import_kolmafia62.myHash)()}`);
}
function bat_skillValid(sk) {
  if (import_kolmafia62.Skill.get(["Savage Bite", "Crush", "Baleful Howl", "Ceaseless Snarl"]).includes(sk) && (0, import_kolmafia62.haveEffect)(import_kolmafia62.Effect.get("Bats Form")) + (0, import_kolmafia62.haveEffect)(import_kolmafia62.Effect.get("Mist Form")) > 0) {
    return false;
  }
  if (import_kolmafia62.Skill.get(["Blood Spike", "Blood Chains", "Chill of the Tomb", "Blood Cloak"]).includes(sk) && (0, import_kolmafia62.haveEffect)(import_kolmafia62.Effect.get("Wolf Form")) + (0, import_kolmafia62.haveEffect)(import_kolmafia62.Effect.get("Bats Form")) > 0) {
    return false;
  }
  if (import_kolmafia62.Skill.get(["Piercing Gaze", "Perceive Soul", "Ensorcel", "Spectral Awareness"]).includes(sk) && (0, import_kolmafia62.haveEffect)(import_kolmafia62.Effect.get("Wolf Form")) + (0, import_kolmafia62.haveEffect)(import_kolmafia62.Effect.get("Mist Form")) > 0) {
    return false;
  }
  if ((0, import_kolmafia62.mpCost)(sk) > 0 && in_darkGyffte()) {
    return false;
  }
  return true;
}
...
function auto_havePeridot() {
  var pop = import_kolmafia65.Item.get("Peridot of Peril");
...
function peridotManuallyDesiredMonsters() {
  ...
  desired_monsters.set(import_kolmafia65.Monster.get("lobsterfrogman"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("black panther"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("white lion"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("monstrous boiler"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("modern zmobie"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("dairy goat"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("writing desk"), true);
  if ((0, import_kolmafia65.itemAmount)(import_kolmafia65.Item.get("star chart")) === 0) {
    desired_monsters.set(import_kolmafia65.Monster.get("Astronomer"), true);
  }
  desired_monsters.set(import_kolmafia65.Monster.get("erudite gremlin (tool)"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("batwinged gremlin (tool)"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("vegetable gremlin (tool)"), true);
  desired_monsters.set(import_kolmafia65.Monster.get("spider gremlin (tool)"), true);
...
function auto_peridotSetZone(loc) {
  ...
  if (loc === import_kolmafia65.Location.get("Sonofa Beach") && auto_spadeDigsRemaining() < 5) {
    return false;
  }
  var desired_locations = /* @__PURE__ */ new Map();
  desired_locations.set(import_kolmafia65.Location.get("Sonofa Beach"), true);
  desired_locations.set(import_kolmafia65.Location.get("The Hatching Chamber"), true);
  desired_locations.set(import_kolmafia65.Location.get("The Feeding Chamber"), true);
  desired_locations.set(import_kolmafia65.Location.get("The Royal Guard Chamber"), true);
  desired_locations.set(import_kolmafia65.Location.get("The Haunted Kitchen"), true);
  desired_locations.set(import_kolmafia65.Location.get("The Unquiet Garves"), true);
  desired_locations.set(import_kolmafia65.Location.get("The Haunted Ballroom"), true);
...
function peridotChoiceHandler(choice, page) {
  if (!auto_havePeridot()) {
    (0, import_kolmafia65.runChoice)(2);
  }
  var popChoice = import_kolmafia65.Monster.none;
  var loc = (0, import_kolmafia65.myLocation)();
  var mons = new AshMatcher('bandersnatch" value="(\\d+)', page);
  var monOpts = /* @__PURE__ */ new Map();
  var i = 0;
  var bestmon = 0;
  while (mons.find()) {
    monOpts.set(i, (0, import_kolmafia65.toMonster)((0, import_kolmafia65.toInt)(mons.group(1))));
    if (peridotManuallyDesiredMonsters().has(monOpts.get(i) ?? monOpts.set(i, import_kolmafia65.Monster.none).get(i))) {
      bestmon = i;
      break;
    }
    if (zoneRank$1(monOpts.get(i) ?? monOpts.set(i, import_kolmafia65.Monster.none).get(i), loc) <= zoneRank$1(monOpts.get(bestmon) ?? monOpts.set(bestmon, import_kolmafia65.Monster.none).get(bestmon), loc)) {
      bestmon = i;
    }
    i += 1;
  }
  popChoice = monOpts.get(bestmon) ?? monOpts.set(bestmon, import_kolmafia65.Monster.none).get(bestmon);
  if ((0, import_kolmafia65.toInt)(popChoice) === 0 || auto_peridotSetZone(loc)) {
    handleTracker$2(import_kolmafia65.Item.get("Peridot of Peril").toString(), loc.toString(), "Peace out", "auto_mapperidot");
    (0, import_kolmafia65.runChoice)(2);
    return;
  }
  handleTracker$2(import_kolmafia65.Item.get("Peridot of Peril").toString(), loc.toString(), popChoice.toString(), "auto_mapperidot");
  (0, import_kolmafia65.runChoice)(1, `bandersnatch=${(0, import_kolmafia65.toInt)(popChoice)}`);
  return;
}
function auto_haveMobiusRing() {
  var ring = import_kolmafia65.Item.get("M&ouml;bius ring");
  return auto_is_valid(ring) && possessEquipment(ring);
}
function auto_paradoxicity() {
  (0, import_kolmafia65.visitUrl)("charpane.php", false);
  return (0, import_kolmafia65.myParadoxicity)();
}
function mobiusChoiceHandler(choice, page) {
  if (!auto_haveMobiusRing()) {
    (0, import_kolmafia65.runChoice)(1);
  }
  var choices = new Map(Object.entries((0, import_kolmafia65.availableChoiceOptions)()).map((_ref3) => {
    var _ref4 = _slicedToArray(_ref3, 2), _k = _ref4[0], _v = _ref4[1];
    return [(0, import_kolmafia65.toInt)(_k), _v];
  }));
  ...
  function mobiusChoice(opt) {
    ...
    handleTracker$1(import_kolmafia65.Item.get("M&ouml;bius ring").toString(), opt, "auto_otherstuff");
    (0, import_kolmafia65.runChoice)(num);
  }
  var pos = "";
  if (in_amw()) {
    ...
    if ((0, import_kolmafia65.myDaycount)() > 1) {
      pos = "Hey, free gun!";
      if (choiceMap.has(pos)) {
        mobiusChoice(pos);
        return;
  ...
  if (isAboutToPowerlevel()) {
    ...
    switch ((0, import_kolmafia65.myPrimestat)()) {
      case import_kolmafia65.Stat.get("Muscle"):
        ...
        break;
      case import_kolmafia65.Stat.get("Mysticality"):
        ...
        break;
      case import_kolmafia65.Stat.get("Moxie"):
  ...
  if (canEat$1(import_kolmafia65.Item.get("Susie's cupcake"))) {
  ...
  if ((0, import_kolmafia65.toInt)((0, import_kolmafia65.getProperty)("_clocksUsed")) < 2) {
    pos = "Go back and set an alarm";
    if (choiceMap.has(pos)) {
      mobiusChoice(pos);
      if ((0, import_kolmafia65.itemAmount)(import_kolmafia65.Item.get("clock")) > 0) {
        (0, import_kolmafia65.use)(1, import_kolmafia65.Item.get("clock"));
      }
      return;
    }
  ...
  if ((0, import_kolmafia65.haveEffect)(import_kolmafia65.Effect.get("Lifted by your Bootstraps")) === 0) {
...
var c2t_megg_oldFam = import_kolmafia68.Familiar.none;
var c2t_megg_oldEq = import_kolmafia68.Item.none;
...
function dartChoiceHandler(choice, options) {
  ...
  for (var _i2 = 0, _arr = ["impress", "better", "targeting", "butt"]; _i2 < _arr.length; _i2++) {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
        ...
        if ((0, import_kolmafia69.containsText)((0, import_kolmafia69.toLowerCase)(str), perk)) {
          dcchoice = idx;
          break;
        }
      }
  ...
  (0, import_kolmafia69.runChoice)(dcchoice);
}
...
function juneCleaverChoiceHandler(choice) {
  switch (choice) {
    case 1467:
      if ((0, import_kolmafia96.haveSkill)(import_kolmafia96.Skill.get("Tongue of the Walrus")) || (0, import_kolmafia96.itemAmount)(import_kolmafia96.Item.get("personal massager")) > 0) {
        (0, import_kolmafia96.runChoice)(3);
      } else if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Mysticality") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma()) || (0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Moxie") && (0, import_kolmafia96.myLevel)() > 12 && disregardInstantKarma() === false) {
        (0, import_kolmafia96.runChoice)(2);
      } else {
        (0, import_kolmafia96.runChoice)(1);
      }
      break;
    case 1468:
      if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Moxie") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma()) || (0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Muscle") && (0, import_kolmafia96.myLevel)() > 12 && disregardInstantKarma() === false) {
        (0, import_kolmafia96.runChoice)(1);
      } else if ((0, import_kolmafia96.toInt)((0, import_kolmafia96.getProperty)("_juneCleaverSkips")) < 5) {
        (0, import_kolmafia96.runChoice)(4);
      } else {
        (0, import_kolmafia96.runChoice)(2);
      }
      break;
    case 1469:
      if ((0, import_kolmafia96.myMeat)() < meatReserve()) {
        (0, import_kolmafia96.runChoice)(3);
      } else if (canDrink$1(import_kolmafia96.Item.get("Dad's brandy")) && (0, import_kolmafia96.myInebriety)() < (0, import_kolmafia96.inebrietyLimit)()) {
        (0, import_kolmafia96.runChoice)(2);
      } else {
        (0, import_kolmafia96.runChoice)(3);
      }
      break;
    case 1470:
      if ((0, import_kolmafia96.canEquip)(import_kolmafia96.Item.get("teacher's pen")) && (0, import_kolmafia96.availableAmount)(import_kolmafia96.Item.get("teacher's pen")) < 1) {
        (0, import_kolmafia96.runChoice)(2);
      } else if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Muscle") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma())) {
        (0, import_kolmafia96.runChoice)(3);
      } else if ((0, import_kolmafia96.toInt)((0, import_kolmafia96.getProperty)("_juneCleaverSkips")) < 5) {
        (0, import_kolmafia96.runChoice)(4);
      } else {
      ...
      break;
    case 1471:
      if ((0, import_kolmafia96.getProperty)("sidequestNunsCompleted") === "none" && (0, import_kolmafia96.getProperty)("auto_skipNuns") === "false" && (0, import_kolmafia96.itemAmount)(import_kolmafia96.Item.get("savings bond")) === 0) {
        (0, import_kolmafia96.runChoice)(1);
      } else if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Mysticality") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma())) {
        (0, import_kolmafia96.runChoice)(3);
      } else {
        (0, import_kolmafia96.runChoice)(1);
      }
    ...
    case 1472:
      ...
      break;
    case 1473:
      if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Muscle") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma())) {
        (0, import_kolmafia96.runChoice)(1);
      } else if ((0, import_kolmafia96.toInt)((0, import_kolmafia96.getProperty)("_juneCleaverSkips")) < 5) {
        (0, import_kolmafia96.runChoice)(4);
      } else {
      ...
      break;
    case 1474:
      if ((0, import_kolmafia96.canEat)() && (0, import_kolmafia96.myLevel)() < 13 && have_fireworks_shop() && auto_is_valid(import_kolmafia96.Item.get("red rocket")) && !in_darkGyffte() && !is_jarlsberg() && !in_tcrs() && auto_is_valid(
        //paths that can eat but can't eat guilty sprouts/won't get the stats from it anyway
        import_kolmafia96.Item.get("guilty sprout")
      ) && (0, import_kolmafia96.itemAmount)(import_kolmafia96.Item.get("guilty sprout")) === 0) {
        (0, import_kolmafia96.runChoice)(2);
      }
      if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Mysticality") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma())) {
        (0, import_kolmafia96.runChoice)(1);
      } else if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Muscle") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma())) {
        (0, import_kolmafia96.runChoice)(3);
      } else {
      ...
      break;
    case 1475:
      if ((0, import_kolmafia96.availableAmount)(import_kolmafia96.Item.get("mother's necklace")) < 1) {
        (0, import_kolmafia96.runChoice)(1);
      } else if ((0, import_kolmafia96.myPrimestat)() === import_kolmafia96.Stat.get("Muscle") && ((0, import_kolmafia96.myLevel)() < 13 || disregardInstantKarma())) {
        (0, import_kolmafia96.runChoice)(2);
      } else {
      ...
      break;
    default:
      (0, import_kolmafia96.abort)("unhandled choice in juneCleaverChoiceHandler");
  }
}
...
function doghouseChoiceHandler(choice) {
  if (choice === 1106) {
    if ((0, import_kolmafia97.inHardcore)() && (0, import_kolmafia97.haveEffect)(import_kolmafia97.Effect.get("Adventurer's Best Friendship")) > 120 || (0, import_kolmafia97.haveEffect)(import_kolmafia97.Effect.get("Adventurer's Best Friendship")) > 30 && pathHasFamiliar()) {
...
function isActuallyEd() {
  return (0, import_kolmafia99.myPath)() === import_kolmafia99.Path.get("Actually Ed the Undying");
}
function ed_spleen_limit() {
  var limit = 5;
  var _iterator = _createForOfIteratorHelper(
    import_kolmafia99.Skill.get(["Extra Spleen", "Another Extra Spleen", "Yet Another Extra Spleen", "Still Another Extra Spleen", "Just One More Extra Spleen", "Okay Seriously, This is the Last Spleen"])
  ), _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var sk = _step.value;
...
function ed_nextUpgrade() {
  var coins = (0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("Ka coin"));
  var canEat_1 = ((0, import_kolmafia99.spleenLimit)() - (0, import_kolmafia99.mySpleenUse)()) / 5;
  if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Upgraded Legs")) && (0, import_kolmafia99.toBoolean)((0, import_kolmafia99.getProperty)("auto_needLegs"))) {
    return import_kolmafia99.Skill.get("Upgraded Legs");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Extra Spleen")) && canEat_1 < 1) {
    return import_kolmafia99.Skill.get("Extra Spleen");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Another Extra Spleen")) && canEat_1 < 1) {
    return import_kolmafia99.Skill.get("Another Extra Spleen");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Replacement Liver"))) {
    return import_kolmafia99.Skill.get("Replacement Liver");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Upgraded Legs"))) {
    return import_kolmafia99.Skill.get("Upgraded Legs");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("More Legs"))) {
    return import_kolmafia99.Skill.get("More Legs");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Yet Another Extra Spleen")) && (0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Another Extra Spleen"))) {
    return import_kolmafia99.Skill.get("Yet Another Extra Spleen");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Still Another Extra Spleen"))) {
    return import_kolmafia99.Skill.get("Still Another Extra Spleen");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Just One More Extra Spleen"))) {
    return import_kolmafia99.Skill.get("Just One More Extra Spleen");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Replacement Stomach"))) {
    return import_kolmafia99.Skill.get("Replacement Stomach");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Elemental Wards"))) {
    return import_kolmafia99.Skill.get("Elemental Wards");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Okay Seriously, This is the Last Spleen"))) {
    return import_kolmafia99.Skill.get("Okay Seriously, This is the Last Spleen");
  } else if (!possessEquipment(import_kolmafia99.Item.get("The Crown of Ed the Undying")) && !(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Tougher Skin"))) {
    return import_kolmafia99.Skill.get("Tougher Skin");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("More Elemental Wards"))) {
    return import_kolmafia99.Skill.get("More Elemental Wards");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Even More Elemental Wards"))) {
    return import_kolmafia99.Skill.get("Even More Elemental Wards");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Healing Scarabs")) && (0, import_kolmafia99.myDaycount)() >= 2) {
    return import_kolmafia99.Skill.get("Healing Scarabs");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Tougher Skin")) && (0, import_kolmafia99.myDaycount)() >= 2 && coins >= 50) {
    return import_kolmafia99.Skill.get("Tougher Skin");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Armor Plating")) && (0, import_kolmafia99.myDaycount)() >= 2 && coins >= 50) {
    return import_kolmafia99.Skill.get("Armor Plating");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Upgraded Spine")) && (0, import_kolmafia99.myDaycount)() >= 2 && coins >= 50) {
    return import_kolmafia99.Skill.get("Upgraded Spine");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Upgraded Arms")) && (0, import_kolmafia99.myDaycount)() >= 2 && coins >= 50) {
    return import_kolmafia99.Skill.get("Upgraded Arms");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Arm Blade")) && (0, import_kolmafia99.myDaycount)() >= 4 && coins >= 100) {
    return import_kolmafia99.Skill.get("Arm Blade");
  } else if (!(0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Bone Spikes")) && (0, import_kolmafia99.myDaycount)() >= 4 && coins >= 100) {
    return import_kolmafia99.Skill.get("Bone Spikes");
  }
...
function ed_KaCost(upgrade) {
  $_ed_KaCost_kaNeeded ?? ($_ed_KaCost_kaNeeded = /* @__PURE__ */ new Map(
    [
      [import_kolmafia99.Skill.get("Extra Spleen"), 5],
      [import_kolmafia99.Skill.get("Another Extra Spleen"), 10],
      [import_kolmafia99.Skill.get("Upgraded Legs"), 10],
      [import_kolmafia99.Skill.get("Tougher Skin"), 10],
      [import_kolmafia99.Skill.get("Armor Plating"), 10],
      [import_kolmafia99.Skill.get("Healing Scarabs"), 10],
      [import_kolmafia99.Skill.get("Elemental Wards"), 10],
      [import_kolmafia99.Skill.get("Yet Another Extra Spleen"), 15],
      [import_kolmafia99.Skill.get("Still Another Extra Spleen"), 20],
      [import_kolmafia99.Skill.get("More Legs"), 20],
      [import_kolmafia99.Skill.get("Upgraded Arms"), 20],
      [import_kolmafia99.Skill.get("Upgraded Spine"), 20],
      [import_kolmafia99.Skill.get("Bone Spikes"), 20],
      [import_kolmafia99.Skill.get("Arm Blade"), 20],
      [import_kolmafia99.Skill.get("More Elemental Wards"), 20],
      [import_kolmafia99.Skill.get("Just One More Extra Spleen"), 25],
      [import_kolmafia99.Skill.get("Replacement Stomach"), 30],
      [import_kolmafia99.Skill.get("Replacement Liver"), 30],
      [import_kolmafia99.Skill.get("Okay Seriously, This is the Last Spleen"), 30],
      [import_kolmafia99.Skill.get("Even More Elemental Wards"), 30]
    ]
  ));
...
function ed_shopping() {
  ...
  function ed_skillID(upgrade) {
    $_ed_skillID_skillIDs ?? ($_ed_skillID_skillIDs = /* @__PURE__ */ new Map(
      [
        [import_kolmafia99.Skill.get("Replacement Stomach"), 28],
        [import_kolmafia99.Skill.get("Replacement Liver"), 29],
        [import_kolmafia99.Skill.get("Extra Spleen"), 30],
        [import_kolmafia99.Skill.get("Another Extra Spleen"), 31],
        [import_kolmafia99.Skill.get("Yet Another Extra Spleen"), 32],
        [import_kolmafia99.Skill.get("Still Another Extra Spleen"), 33],
        [import_kolmafia99.Skill.get("Just One More Extra Spleen"), 34],
        [import_kolmafia99.Skill.get("Okay Seriously, This is the Last Spleen"), 35],
        [import_kolmafia99.Skill.get("Upgraded Legs"), 36],
        [import_kolmafia99.Skill.get("Upgraded Arms"), 37],
        [import_kolmafia99.Skill.get("Upgraded Spine"), 38],
        [import_kolmafia99.Skill.get("Tougher Skin"), 39],
        [import_kolmafia99.Skill.get("Armor Plating"), 40],
        [import_kolmafia99.Skill.get("Bone Spikes"), 41],
        [import_kolmafia99.Skill.get("Arm Blade"), 42],
        [import_kolmafia99.Skill.get("Healing Scarabs"), 43],
        [import_kolmafia99.Skill.get("Elemental Wards"), 44],
        [import_kolmafia99.Skill.get("More Elemental Wards"), 45],
        [import_kolmafia99.Skill.get("Even More Elemental Wards"), 46],
        [import_kolmafia99.Skill.get("More Legs"), 48]
      ]
    ));
  ...
  canEat_1 -= (0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("mummified beef haunch"));
  while (coins >= 15 && canEat_1 > 0) {
    (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=428", true);
    auto_log_info("Buying a mummified beef haunch!", "green");
    coins -= 15;
    canEat_1--;
  }
  if (!(0, import_kolmafia99.toBoolean)((0, import_kolmafia99.getProperty)("lovebugsUnlocked")) && coins >= 1 && (0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("holy spring water")) === 0 && (0, import_kolmafia99.myMp)() < (0, import_kolmafia99.mpCost)(import_kolmafia99.Skill.get("Storm of the Scarab"))) {
    auto_log_info("Buying Holy Spring Water", "green");
    (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=436", true);
    coins -= 1;
  }
  if (canEat_1 < 1) {
    ...
    if (requiredKa !== -1 && coins >= requiredKa) {
      ...
      if (skillBuy !== 0) {
        (0, import_kolmafia99.visitUrl)("place.php?whichplace=edunder&action=edunder_bodyshop");
        (0, import_kolmafia99.visitUrl)(`choice.php?pwd&skillid=${skillBuy}&option=1&whichchoice=1052`, true);
        (0, import_kolmafia99.visitUrl)("choice.php?pwd&option=2&whichchoice=1052", true);
        coins -= requiredKa;
      }
    } else if ((0, import_kolmafia99.haveSkill)(import_kolmafia99.Skill.get("Okay Seriously, This is the Last Spleen")) && canEat_1 < 1) {
      while ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("talisman of Renenutet")) < 7 && (0, import_kolmafia99.toInt)((0, import_kolmafia99.getProperty)("auto_renenutetBought")) < 7 && coins >= 1) {
        auto_log_info("Buying Talisman of Renenutet", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=439", true);
        (0, import_kolmafia99.setProperty)("auto_renenutetBought", (1 + (0, import_kolmafia99.toInt)((0, import_kolmafia99.getProperty)("auto_renenutetBought"))).toString());
        coins -= 1;
      }
      while ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("linen bandages")) < 8 && coins >= 1) {
        auto_log_info("Buying Linen Bandages", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=429", true);
        coins -= 1;
      }
      if ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("holy spring water")) === 0 && coins >= 1) {
        auto_log_info("Buying Holy Spring Water", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=436", true);
        coins -= 1;
      }
      while ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("talisman of Horus")) < 2 && coins >= 5) {
        auto_log_info("Buying Talisman of Horus", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=693", true);
        coins -= 5;
      }
      if ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("spirit beer")) === 0 && coins >= 30) {
        auto_log_info("Buying Spirit Beer", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=432", true);
        coins -= 2;
      }
      if ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("soft green echo eyedrop antidote")) + (0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("ancient cure-all")) < 2 && coins >= 30) {
        auto_log_info("Buying Ancient Cure-all", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=435", true);
        coins -= 3;
      }
      if ((0, import_kolmafia99.itemAmount)(import_kolmafia99.Item.get("sacramental wine")) === 0 && coins >= 30) {
        auto_log_info("Buying Sacramental Wine", "green");
        (0, import_kolmafia99.visitUrl)("shop.php?pwd=&whichshop=edunder_shopshop&action=buyitem&quantity=1&whichrow=433", true);
        coins -= 3;
      }
    }
  }
...
function edUnderworldChoiceHandler(choice) {
  ...
  if (choice === 1023) {
    ...
    auto_log_info(`Ed died in combat ${(0, import_kolmafia99.toInt)((0, import_kolmafia99.getProperty)("_edDefeats"))} time(s)`, "blue");
    ed_shopping();
    ...
    if ((0, import_kolmafia99.toInt)((0, import_kolmafia99.getProperty)("_edDefeats")) < (0, import_kolmafia99.toInt)((0, import_kolmafia99.getProperty)("edDefeatAbort"))) {
      ...
      (0, import_kolmafia99.setProperty)("auto_beatenUpCount", ((0, import_kolmafia99.toInt)((0, import_kolmafia99.getProperty)("auto_beatenUpCount")) + 1).toString());
    }
  } else {
...
function neverendingPartyChoiceHandler(choice) {
  if (choice === 1322) {
    ...
    switch ((0, import_kolmafia101.myPrimestat)()) {
      case import_kolmafia101.Stat.get("Muscle"):
        buff = import_kolmafia101.Effect.get("Spiced Up");
        break;
      case import_kolmafia101.Stat.get("Mysticality"):
        buff = import_kolmafia101.Effect.get("Tomes of Opportunity");
        break;
      case import_kolmafia101.Stat.get("Moxie"):
        buff = import_kolmafia101.Effect.get("The Best Hair You've Ever Had");
        break;
    }
    if (in_glover()) {
      ...
      if ((0, import_kolmafia101.haveEffect)(import_kolmafia101.Effect.get("Citronella Armpits")) < 9) {
    ...
    if ((0, import_kolmafia101.myPrimestat)() === import_kolmafia101.Stat.get("Mysticality")) {
      (0, import_kolmafia101.runChoice)(2);
    } else {
      (0, import_kolmafia101.runChoice)(1);
    }
  } else if (choice === 1326) {
    if ((0, import_kolmafia101.myPrimestat)() === import_kolmafia101.Stat.get("Muscle")) {
      (0, import_kolmafia101.runChoice)(2);
    } else {
      (0, import_kolmafia101.runChoice)(1);
    }
    ...
    if ((0, import_kolmafia101.myPrimestat)() === import_kolmafia101.Stat.get("Moxie")) {
      (0, import_kolmafia101.runChoice)(2);
    } else {
      (0, import_kolmafia101.runChoice)(1);
    }
...
function auto_latteDropName(l) {
  switch (l) {
    case import_kolmafia101.Location.get("The Mouldering Mansion"):
      return "ancient";
    case import_kolmafia101.Location.get("The Overgrown Lot"):
      return "basil";
    case import_kolmafia101.Location.get("Whitey's Grove"):
      return "belgian";
    case import_kolmafia101.Location.get("The Bugbear Pen"):
      return "bug-thistle";
    case import_kolmafia101.Location.get("Madness Bakery"):
      return "butternut";
    case import_kolmafia101.Location.get("The Black Forest"):
      return "cajun";
    case import_kolmafia101.Location.get("The Haunted Billiards Room"):
      return "chalk";
    case import_kolmafia101.Location.get("The Dire Warren"):
      return "carrot";
    case import_kolmafia101.Location.get("Barrrney's Barrr"):
      return "carrrdamom";
    case import_kolmafia101.Location.get("The Haunted Kitchen"):
      return "chili";
    case import_kolmafia101.Location.get("The Sleazy Back Alley"):
      return "cloves";
    case import_kolmafia101.Location.get("The Haunted Boiler Room"):
      return "coal";
    case import_kolmafia101.Location.get("The Icy Peak"):
      return "cocoa";
    case import_kolmafia101.Location.get("The Cola Wars Battlefield"):
      return "diet";
    case import_kolmafia101.Location.get("Itznotyerzitz Mine"):
      return "dwarf";
    case import_kolmafia101.Location.get("The Feeding Chamber"):
      return "filth";
    case import_kolmafia101.Location.get("The Road to the White Citadel"):
      return "flour";
    case import_kolmafia101.Location.get("The Fungal Nethers"):
      return "fungus";
    case import_kolmafia101.Location.get("The Hidden Park"):
      return "grass";
    case import_kolmafia101.Location.get("Cobb's Knob Barracks"):
      return "greasy";
    case import_kolmafia101.Location.get("The Daily Dungeon"):
      return "healing";
    case import_kolmafia101.Location.get("The Dark Neck of the Woods"):
      return "hellion";
    case import_kolmafia101.Location.get("Wartime Frat House (Hippy Disguise)"):
      return "greek";
    case import_kolmafia101.Location.get("The Old Rubee Mine"):
      return "grobold";
    case import_kolmafia101.Location.get("The Bat Hole Entrance"):
      return "guarna";
    case import_kolmafia101.Location.get("1st Floor, Shiawase-Mitsuhama Building"):
      return "gunpowder";
    case import_kolmafia101.Location.get("Hobopolis Town Square"):
      return "hobo";
    case import_kolmafia101.Location.get("The Haunted Library"):
      return "ink";
    case import_kolmafia101.Location.get("Wartime Hippy Camp (Frat Disguise)"):
      return "kombucha";
    case import_kolmafia101.Location.get("The Defiled Niche"):
      return "lihc";
    case import_kolmafia101.Location.get("The Arid, Extra-Dry Desert"):
      return "lizard";
    case import_kolmafia101.Location.get("Cobb's Knob Laboratory"):
      return "mega";
    case import_kolmafia101.Location.get("The Unquiet Garves"):
      return "mold";
    case import_kolmafia101.Location.get("The Briniest Deepests"):
      return "msg";
    case import_kolmafia101.Location.get("The Haunted Pantry"):
      return "noodles";
    case import_kolmafia101.Location.get("The Ice Hole"):
      return "norwhal";
    case import_kolmafia101.Location.get("The Old Landfill"):
      return "oil";
    case import_kolmafia101.Location.get("The Haunted Gallery"):
      return "paint";
    case import_kolmafia101.Location.get("The Stately Pleasure Dome"):
      return "paradise";
    case import_kolmafia101.Location.get("The Spooky Forest"):
      return "rawhide";
    case import_kolmafia101.Location.get("The Brinier Deepers"):
      return "rock";
    case import_kolmafia101.Location.get("The Briny Deeps"):
      return "salt";
    case import_kolmafia101.Location.get("Noob Cave"):
      return "sandalwood";
    case import_kolmafia101.Location.get("Cobb's Knob Kitchens"):
      return "sausage";
    case import_kolmafia101.Location.get("The Hole in the Sky"):
      return "space";
    case import_kolmafia101.Location.get("The Copperhead Club"):
      return "squash";
    case import_kolmafia101.Location.get("The Caliginous Abyss"):
      return "squamous";
    case import_kolmafia101.Location.get("The VERY Unquiet Garves"):
      return "teeth";
    case import_kolmafia101.Location.get("The Middle Chamber"):
      return "venom";
    case import_kolmafia101.Location.get("The Dark Elbow of the Woods"):
      return "vitamins";
    case import_kolmafia101.Location.get("The Dark Heart of the Woods"):
      return "wing";
    default:
      return "";
  }
...
function auto_latteDropAvailable(l) {
  if ((0, import_kolmafia101.availableAmount)(import_kolmafia101.Item.get("latte lovers member's mug")) === 0) {
    return false;
  }
...
function itznotyerzitzMineChoiceHandler(choice) {
  ...
  if (choice === 18) {
    if (possessEquipment(import_kolmafia103.Item.get("miner's pants"))) {
      if (possessEquipment(import_kolmafia103.Item.get("7-Foot Dwarven mattock"))) {
    ...
    if (possessEquipment(import_kolmafia103.Item.get("miner's helmet"))) {
      if (possessEquipment(import_kolmafia103.Item.get("miner's pants"))) {
        (0, import_kolmafia103.runChoice)(3);
      } else {
        (0, import_kolmafia103.runChoice)(2);
...
function theeXtremeSlopeChoiceHandler(choice) {
  ...
  if (choice === 15) {
    if (possessEquipment(import_kolmafia103.Item.get("eXtreme mittens"))) {
      if (possessEquipment(import_kolmafia103.Item.get("eXtreme scarf"))) {
        (0, import_kolmafia103.runChoice)(3);
      } else {
        (0, import_kolmafia103.runChoice)(2);
      }
    ...
    if (possessEquipment(import_kolmafia103.Item.get("snowboarder pants"))) {
      if (possessEquipment(import_kolmafia103.Item.get("eXtreme scarf"))) {
        (0, import_kolmafia103.runChoice)(3);
      } else {
        (0, import_kolmafia103.runChoice)(2);
    ...
    if ((0, import_kolmafia103.haveEquipped)(import_kolmafia103.Item.get("candy cane sword cane"))) {
...
$_f_importantMonsters ?? ($_f_importantMonsters = import_kolmafia109.Monster.get([
  // L4:
  "beanbat",
  // L5:
...
function auto_have_familiar(fam) {
  ...
  if ((0, import_kolmafia110.getProperty)("auto_blacklistFamiliar") !== "") {
    var noFams = new Map((0, import_kolmafia110.splitString)((0, import_kolmafia110.getProperty)("auto_blacklistFamiliar"), ";").map((_v, _i) => [_i, _v]));
    var _iterator2 = _createForOfIteratorHelper(
      noFams
    ), _step2;
    try {
...
function expectGhostReport() {
  if ((0, import_kolmafia113.totalTurnsPlayed)() >= (0, import_kolmafia113.toInt)((0, import_kolmafia113.getProperty)("nextParanormalActivity"))) {
    if ((0, import_kolmafia113.totalTurnsPlayed)() > (0, import_kolmafia113.toInt)((0, import_kolmafia113.getProperty)("nextParanormalActivity"))) {
      ...
      var myGhost = new AshMatcher('<tr rel="protonquest">(?:.*?)<b>(.*?)</b>', page);
      if (myGhost.find()) {
...
function auto_combat_appearance_rates(place, queue) {
  var res_including_noncombat = new Map(Object.entries((0, import_kolmafia120.appearanceRates)(place, queue)).map((_ref) => {
    var _ref2 = _slicedToArray(_ref, 2), _k = _ref2[0], _v = _ref2[1];
    return [import_kolmafia120.Monster.get(_k), _v];
  }));
...
function hasTorso$1() {
  return (0, import_kolmafia120.haveSkill)(import_kolmafia120.Skill.get("Torso Awareness")) || (0, import_kolmafia120.haveSkill)(import_kolmafia120.Skill.get("Best Dressed")) || robot_cpu(9, false);
}
function isGuildClass() {
  return import_kolmafia120.Class.get(["Seal Clubber", "Turtle Tamer", "Sauceror", "Pastamancer", "Disco Bandit", "Accordion Thief"]).includes((0, import_kolmafia120.myClass)());
}
...
function effectiveDropChance(it, baseDropRate) {
  ...
  if (baseDropRate > 0) {
    ...
    if ((0, import_kolmafia120.toSlot)(it) !== import_kolmafia120.Slot.none && import_kolmafia120.Slot.get(["hat", "shirt", "weapon", "off-hand", "pants", "acc1", "acc2", "acc3", "back"]).includes((0, import_kolmafia120.toSlot)(it))) {
      item_modifier += (0, import_kolmafia120.numericModifier)("Gear Drop");
      if ((0, import_kolmafia120.toSlot)(it) === import_kolmafia120.Slot.get("hat")) {
        item_modifier += (0, import_kolmafia120.numericModifier)("Hat Drop");
      }
      if ((0, import_kolmafia120.toSlot)(it) === import_kolmafia120.Slot.get("shirt")) {
        item_modifier += (0, import_kolmafia120.numericModifier)("Shirt Drop");
      }
      if ((0, import_kolmafia120.toSlot)(it) === import_kolmafia120.Slot.get("weapon")) {
        item_modifier += (0, import_kolmafia120.numericModifier)("Weapon Drop");
      }
      if ((0, import_kolmafia120.toSlot)(it) === import_kolmafia120.Slot.get("off-hand")) {
        item_modifier += (0, import_kolmafia120.numericModifier)("Offhand Drop");
      }
      if ((0, import_kolmafia120.toSlot)(it) === import_kolmafia120.Slot.get("pants")) {
        item_modifier += (0, import_kolmafia120.numericModifier)("Pants Drop");
      }
      if (import_kolmafia120.Slot.get(["acc1", "acc2", "acc3"]).includes((0, import_kolmafia120.toSlot)(it))) {
  ...
  if (retval > 0) {
    ...
    if (in_heavyrains()) {
      var depth = (0, import_kolmafia120.toInt)((0, import_kolmafia120.myLocation)().waterLevel + (0, import_kolmafia120.numericModifier)("Water Level"));
      depth = (0, import_kolmafia120.max)(1, depth);
      depth = (0, import_kolmafia120.min)(6, depth);
      var heavyrainsWashChance = 5 * depth / 100;
      if ((0, import_kolmafia120.haveEffect)(import_kolmafia120.Effect.get("Fishy Whiskers")) > 0) {
        heavyrainsWashChance -= 0.1;
      }
      if ((0, import_kolmafia120.equippedAmount)(import_kolmafia120.Item.get("fishbone catcher's mitt")) > 0) {
        heavyrainsWashChance -= 0.1;
      }
    ...
    if ((0, import_kolmafia120.myFamiliar)() === import_kolmafia120.Familiar.get("Black Cat")) {
      retval = retval * 0.75;
    } else if ((0, import_kolmafia120.myFamiliar)() === import_kolmafia120.Familiar.get("O.A.F.")) {
      retval = retval * 0.75;
    }
  }
...
function auto_is_valid(it) {
  if (!glover_usable(it.toString())) {
    if (it !== import_kolmafia120.Item.get("protonic accelerator pack")) {
      return false;
    } else if (!expectGhostReport() && !haveGhostReport()) {
      return false;
    }
  }
  if (it === import_kolmafia120.Item.get("grimstone mask")) {
    if (!isGuildClass()) {
      return false;
    }
  }
  ...
  if ((0, import_kolmafia120.myPath)() === import_kolmafia120.Path.get("Trendy")) {
...
function auto_is_valid$2(sk) {
  ...
  if (in_lol() && import_kolmafia120.Skill.get(["Extract", "Turbo", "Digitize", "Duplicate", "Portscan", "Compress"]).includes(sk)) {
    return true;
  }
  if (is_professor() && sk !== (0, import_kolmafia120.toSkill)(7512)) {
    return false;
  }
  return (glover_usable(sk.toString()) || sk.passive && sk !== import_kolmafia120.Skill.get("Disco Nap")) && bat_skillValid(sk) && plumber_skillValid(sk) && (0, import_kolmafia120.isUnrestricted)(sk);
}
...
function auto_check_conditions(conds) {
  ...
  var conditions = new Map((0, import_kolmafia120.splitString)(conds, ";").map((_v, _i) => [_i, _v]));
  var failure = false;
    ...
    var condition_data = m2.group(2);
    {
      ...
      switch (condition_type) {
        ...
        case "pathid":
          ...
          if (req_pathid === 0) {
            (0, import_kolmafia120.abort)(`"${condition_data}" does not properly convert to a path id!`);
          }
        ...
        case "effect":
          ...
          if (req_effect === import_kolmafia120.Effect.none) {
            (0, import_kolmafia120.abort)(`"${condition_data}" does not properly convert to an effect!`);
          }
        ...
        case "item":
          ...
          return compare_numbers((0, import_kolmafia120.itemAmount)(req_item) + (0, import_kolmafia120.equippedAmount)(req_item), (0, import_kolmafia120.toInt)(m5.group(3)), m5.group(2));
        case "itemdropcapped":
        ...
        case "familiar":
          ...
          if (req_familiar === import_kolmafia120.Familiar.none && condition_data !== "none") {
            (0, import_kolmafia120.abort)(`"${condition_data}" does not properly convert to a familiar!`);
          }
        ...
        case "loc":
          ...
          if (req_loc === import_kolmafia120.Location.none) {
            (0, import_kolmafia120.abort)(`"${condition_data}" does not properly convert to a location!`);
          }
          return (0, import_kolmafia120.myLocation)() === req_loc;
        case "turnsspent":
          m6 = new AshMatcher("([^=<>]+)([=<>]+)(.+)", condition_data);
          if (!m6.find()) {
            (0, import_kolmafia120.abort)(`"${condition_data}" is not a proper turnsspent condition format!`);
          }
          ...
          if (!["=", "=="].includes(m6.group(2))) {
            return compare_numbers(loc.turnsSpent, (0, import_kolmafia120.toInt)(m6.group(3)), m6.group(2));
          }
        ...
        case "prop":
          ...
          if (!["=", "=="].includes(m22.group(2))) {
            return compare_numbers((0, import_kolmafia120.toInt)(prop), (0, import_kolmafia120.toInt)(m22.group(3)), m22.group(2));
          }
        ...
        case "quest":
          ...
          if (!m3.find()) {
            (0, import_kolmafia120.abort)(`"${condition_data}" is not a proper quest condition format!`);
          }
        ...
        case "sniffed":
          ...
          if (check_sniffed === import_kolmafia120.Monster.none) {
            (0, import_kolmafia120.abort)(`"${condition_data}" does not properly convert to a monster!`);
          }
          if ((0, import_kolmafia120.haveEffect)(import_kolmafia120.Effect.get("On the Trail")) > 0 && (0, import_kolmafia120.toMonster)((0, import_kolmafia120.getProperty)("olfactedMonster")) === check_sniffed) {
            return true;
          }
          ...
          if (import_kolmafia120.Class.get(["Cow Puncher", "Beanslinger", "Snake Oiler"]).includes((0, import_kolmafia120.myClass)()) && (0, import_kolmafia120.toMonster)((0, import_kolmafia120.getProperty)("longConMonster")) === check_sniffed) {
            return true;
          }
        ...
        case "sgeea":
          ...
          return (0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("soft green echo eyedrop antidote")) >= sgeeas;
        case "day":
        ...
        case "ML":
          ...
          return compare_numbers((0, import_kolmafia120.monsterLevelAdjustment)(), (0, import_kolmafia120.toInt)(m4.group(2)), m4.group(1));
        case "consume":
...
function currentPoolSkill() {
  var poolskill_command = new Map((0, import_kolmafia120.splitString)((0, import_kolmafia120.cliExecuteOutput)("poolskill")).map((_v, _i) => [_i, _v]));
  return (0, import_kolmafia120.toInt)((0, import_kolmafia120.substring)(poolskill_command.get(0) ?? poolskill_command.set(0, "").get(0), (0, import_kolmafia120.lastIndexOf)(poolskill_command.get(0) ?? poolskill_command.set(0, "").get(0), ":") + 2, (0, import_kolmafia120.length)(poolskill_command.get(0) ?? poolskill_command.set(0, "").get(0)) - 1));
}
function poolSkillPracticeGains() {
  var count_1 = 1;
  if ((0, import_kolmafia120.haveEffect)(import_kolmafia120.Effect.get("Chalky Hand")) > 0) {
    count_1 += 1;
  }
  if ((0, import_kolmafia120.equippedAmount)(import_kolmafia120.Item.get("[2268]Staff of Fats")) > 0) {
    count_1 += 2;
  }
  return count_1;
}
function hasUsefulShirt() {
  ...
  var _iterator71 = _createForOfIteratorHelper(
    import_kolmafia120.Item.get(["January's Garbage Tote", "astral shirt", "shoe ad T-shirt", "fresh coat of paint", "tunac", "Jurassic Parka", "hairshirt", "futuristic shirt"])
  ), _step71;
  try {
...
function meatReserve() {
  ...
  if (in_wildfire() && !(0, import_kolmafia120.toBoolean)((0, import_kolmafia120.getProperty)("wildfirePumpGreased")) && (0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("pump grease")) === 0) {
    reserve_extra += (0, import_kolmafia120.npcPrice)(import_kolmafia120.Item.get("pump grease"));
  }
  ...
  if ((0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("your father's MacGuffin diary")) === 0 && !in_koe() && !in_wotsf()) {
    reserve_diary += 500;
    if ((0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("forged identification documents")) === 0) {
      reserve_diary += (0, import_kolmafia120.toInt)(5e3 * npcStoreDiscountMulti());
    }
  }
  if ((0, import_kolmafia120.myLevel)() >= 11 && internalQuestStatus("questL11Ron") < 5 && (0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("Red Zeppelin ticket")) < 1) {
    if (((0, import_kolmafia120.getProperty)("questL11Shen") === "finished" || import_kolmafia120.Location.get("The Copperhead Club").turnsSpent >= 15) && (0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("priceless diamond")) < 1) {
  ...
  if ((0, import_kolmafia120.myLevel)() >= 11 && internalQuestStatus("questL11Palindome") < 1) {
    if ((0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("photograph of a red nugget")) < 1) {
      reserve_palindome += 500;
    }
    if ((0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("photograph of God")) < 1) {
      reserve_palindome += 500;
    }
  }
  if ((0, import_kolmafia120.toInt)((0, import_kolmafia120.getProperty)("lastIslandUnlock")) < (0, import_kolmafia120.myAscensions)()) {
    ...
    if ((0, import_kolmafia120.itemAmount)(import_kolmafia120.Item.get("dingy planks")) === 0) {
...
function npcStoreDiscountMulti() {
  var retval = 1;
  if (auto_have_skill(import_kolmafia122.Skill.get("Five Finger Discount"))) {
    retval -= 0.05;
  }
  if (possessEquipment(import_kolmafia122.Item.get("Travoltan trousers")) && auto_is_valid(import_kolmafia122.Item.get("Travoltan trousers"))) {
    retval -= 0.05;
  }
  return retval;
}
...
function auto_reagnimatedGetPart(choice) {
  if ((0, import_kolmafia132.availableAmount)(import_kolmafia132.Item.get("gnomish housemaid's kgnee")) === 0) {
    (0, import_kolmafia132.runChoice)(4);
  } else if ((0, import_kolmafia132.availableAmount)(import_kolmafia132.Item.get("gnomish coal miner's lung")) === 0) {
    (0, import_kolmafia132.runChoice)(2);
  } else if ((0, import_kolmafia132.availableAmount)(import_kolmafia132.Item.get("gnomish athlete's foot")) === 0) {
    (0, import_kolmafia132.runChoice)(5);
  } else if ((0, import_kolmafia132.availableAmount)(import_kolmafia132.Item.get("gnomish tennis elbow")) === 0) {
    (0, import_kolmafia132.runChoice)(3);
  } else if ((0, import_kolmafia132.availableAmount)(import_kolmafia132.Item.get("gnomish swimmer's ears")) === 0) {
...
function canDrink$2(toDrink, checkValidity) {
  ...
  if (is_jarlsberg() && toDrink !== import_kolmafia135.Item.get("steel margarita")) {
    return (0, import_kolmafia135.sellCost)(import_kolmafia135.Coinmaster.get("Jarlsberg's Cosmic Kitchen"), toDrink).size > 0;
  }
  if (in_nuclear() && toDrink.inebriety > 1) {
    return false;
  }
  if (in_darkGyffte() !== import_kolmafia135.Item.get(["vampagne", "dusty bottle of blood", "Red Russian", "mulled blood", "bottle of Sanguiovese"]).includes(toDrink)) {
    return false;
  }
  if (in_kolhs()) {
    if (!import_kolmafia135.Item.get(["can of the cheapest beer", "bottle of fruity &quot;wine&quot;", "single swig of vodka", "fountain 'soda'", "stepmom's booze", "steel margarita"]).includes(toDrink)) {
      return false;
    }
  }
  if (in_lta()) {
  ...
  if (is_werewolf()) {
    if (import_kolmafia135.Item.get(["Champagne Shimmy", "Charleston Choo-Choo", "Marltini", "Mysterious Stranger", "Strong, Silent Type", "Velvet Veil"]).includes(toDrink)) {
      return false;
    }
  }
...
function canEat$2(toEat, checkValidity) {
  if (!(0, import_kolmafia135.canEat)()) {
    return false;
  }
  ...
  if (is_jarlsberg()) {
    return (0, import_kolmafia135.sellCost)(import_kolmafia135.Coinmaster.get("Jarlsberg's Cosmic Kitchen"), toEat).size > 0;
  }
  if (in_nuclear() && toEat.fullness > 1) {
    return false;
  }
  if (in_darkGyffte() && toEat === import_kolmafia135.Item.get("magical sausage")) {
    return true;
  }
  if (in_darkGyffte() !== import_kolmafia135.Item.get(["blood-soaked sponge cake", "blood roll-up", "blood snowcone", "actual blood sausage", "bloodstick"]).includes(toEat)) {
    return false;
  }
  if (in_zombieSlayer()) {
    return import_kolmafia135.Item.get(["crappy brain", "decent brain", "good brain", "boss brain", "hunter brain", "brains casserole", "fricasseed brains", "steel lasagna"]).includes(toEat);
  }
...
function equipmentAmount(equipment) {
  ...
  if (equipment.toString() in (0, import_kolmafia136.getRelated)(import_kolmafia136.Item.get("broken champagne bottle"), "fold")) {
    amount = (0, import_kolmafia136.itemAmount)(wrap_item(import_kolmafia136.Item.get("January's Garbage Tote")));
  }
  return amount;
}
...
function auto_run_choice(choice, page) {
  ...
  var options = new Map(Object.entries((0, import_kolmafia137.availableChoiceOptions)()).map((_ref) => {
    var _ref2 = _slicedToArray(_ref, 2), _k = _ref2[0], _v = _ref2[1];
  ...
  }));
  {
    ...
    switch (choice) {
      ...
      case 24:
        ...
        break;
      case 89:
        if (isActuallyEd() && (!possessEquipment(import_kolmafia137.Item.get("serpentine sword")) || !possessEquipment(import_kolmafia137.Item.get("snake shield")))) {
          (0, import_kolmafia137.runChoice)(2);
        } else {
      ...
      case 90:
        ...
        break;
      case 105:
        if ((0, import_kolmafia137.myPrimestat)() === import_kolmafia137.Stat.get("Mysticality")) {
      ...
      case 178:
        ...
        break;
      case 182:
        if ((0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("model airship")) === 0) {
          (0, import_kolmafia137.runChoice)(4);
      ...
      case 188:
        if ((0, import_kolmafia137.isWearingOutfit)("Frat Boy Ensemble")) {
          (0, import_kolmafia137.runChoice)(1);
        } else if ((0, import_kolmafia137.equippedAmount)(import_kolmafia137.Item.get("mullet wig")) === 1 && (0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("briefcase")) > 0) {
          (0, import_kolmafia137.runChoice)(2);
        } else if ((0, import_kolmafia137.equippedAmount)(import_kolmafia137.Item.get("frilly skirt")) === 1 && (0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("hot wing")) > 2) {
          (0, import_kolmafia137.runChoice)(3);
        } else {
          (0, import_kolmafia137.abort)("I tried to infiltrate the orcish frat house without being equipped for the job");
        }
        break;
      case 189:
        (0, import_kolmafia137.runChoice)(2);
      ...
      case 588:
        ...
        break;
      case 589:
        if ((0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("bugbear autopsy tweezers")) > 0) {
          for (var i = 1; i <= 5; i++) {
            if (options.has(i)) {
      ...
      case 605:
        ...
        break;
      case 606:
        if (in_bhy() || in_glover() && options.has(3) && (0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("jar of oil")) === 0) {
          (0, import_kolmafia137.runChoice)(6);
          break;
        }
        if (options.has(4)) {
        ...
        if (options.has(3) && (0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("jar of oil")) > 0) {
          (0, import_kolmafia137.runChoice)(3);
          break;
        }
        if (options.has(2)) {
      ...
      case 768:
        if (in_quantumTerrarium()) {
          if ((0, import_kolmafia137.myLocation)() === import_kolmafia137.Location.get("The Themthar Hills")) {
            (0, import_kolmafia137.runChoice)(4);
      ...
      case 793:
        if (options.has(5) && (0, import_kolmafia137.toBoolean)((0, import_kolmafia137.getProperty)("auto_considerCCSCShore"))) {
          (0, import_kolmafia137.runChoice)(5);
        } else if ((0, import_kolmafia137.myPrimestat)() === import_kolmafia137.Stat.get("Muscle")) {
          (0, import_kolmafia137.runChoice)(1);
        } else if ((0, import_kolmafia137.myPrimestat)() === import_kolmafia137.Stat.get("Mysticality")) {
          (0, import_kolmafia137.runChoice)(2);
        } else {
          (0, import_kolmafia137.runChoice)(3);
        }
      ...
      case 888:
        ...
        break;
      case 889:
        if ((0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("dictionary")) === 0 && (0, import_kolmafia137.toBoolean)((0, import_kolmafia137.getProperty)("auto_getDictionary"))) {
          (0, import_kolmafia137.runChoice)(4);
        } else {
          (0, import_kolmafia137.runChoice)(5);
        }
      ...
      case 1024:
        ...
        break;
      case 1026:
        if ((0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("electric boning knife")) > 0 || isActuallyEd() || in_bugbear() || in_pokefam()) {
          (0, import_kolmafia137.runChoice)(3);
        } else {
          (0, import_kolmafia137.runChoice)(2);
        }
      ...
      case 1056:
        ...
        break;
      case 1060:
        if ((0, import_kolmafia137.itemAmount)(import_kolmafia137.Item.get("Skeleton Store office key")) === 0) {
          (0, import_kolmafia137.runChoice)(1);
      ...
      case 1261:
        ...
        break;
      case 1310:
        goal = (0, import_kolmafia137.toInt)((0, import_kolmafia137.getProperty)("_auto_lobsterChoice"));
      ...
      case 1475:
        ...
        break;
      case 1491:
        if ((0, import_kolmafia137.myPrimestat)() === import_kolmafia137.Stat.get("Muscle")) {
          (0, import_kolmafia137.runChoice)(1);
        } else if ((0, import_kolmafia137.myPrimestat)() === import_kolmafia137.Stat.get("Mysticality")) {
          (0, import_kolmafia137.runChoice)(2);
        } else {
